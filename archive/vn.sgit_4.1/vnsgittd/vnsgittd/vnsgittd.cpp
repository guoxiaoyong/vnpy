...
void TdApi::OnRspUserLogin(CSgitFtdcRspUserLoginField *pRspUserLogin,
...
void TdApi::OnRspUserLogout(CSgitFtdcUserLogoutField *pUserLogout,
                            CSgitFtdcRspInfoField *pRspInfo, int nRequestID,
                            bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspUserPasswordUpdate(
  ...
  if (pUserPasswordUpdate) {
    ...
    CSgitFtdcUserPasswordUpdateField empty_data =
...
void TdApi::OnRspOrderInsert(CSgitFtdcInputOrderField *pInputOrder,
                             CSgitFtdcRspInfoField *pRspInfo, int nRequestID,
                             bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspOrderAction(CSgitFtdcInputOrderActionField *pInputOrderAction,
                             CSgitFtdcRspInfoField *pRspInfo, int nRequestID,
                             bool bIsLast) {
  Task task = Task();
  ...
  if (pInputOrderAction) {
    ...
    CSgitFtdcInputOrderActionField empty_data =
...
void TdApi::OnRspQryOrder(CSgitFtdcOrderField *pOrder,
                          CSgitFtdcRspInfoField *pRspInfo, int nRequestID,
                          bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryInvestor(CSgitFtdcInvestorField *pInvestor,
                             CSgitFtdcRspInfoField *pRspInfo, int nRequestID,
                             bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryInstrument(CSgitFtdcInstrumentField *pInstrument,
                               CSgitFtdcRspInfoField *pRspInfo, int nRequestID,
                               bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRtnOrder(CSgitFtdcOrderField *pOrder,
...
void TdApi::OnRtnInstrumentStatus(
  ...
  if (pInstrumentStatus) {
    ...
    CSgitFtdcInstrumentStatusField empty_data =
...
void TdApi::OnRspQryInvestorPositionDetail(
  ...
  if (pInvestorPositionDetail) {
    ...
    CSgitFtdcInvestorPositionDetailField empty_data =
...
void TdApi::OnRspQryInvestorPosition(
  ...
  if (pInvestorPosition) {
    ...
    CSgitFtdcInvestorPositionField empty_data =
...
void TdApi::processRspUserPasswordUpdate(Task task) {
  PyLock lock;
  CSgitFtdcUserPasswordUpdateField task_data =
      any_cast<CSgitFtdcUserPasswordUpdateField>(task.task_data);
  dict data;
  data["UserID"] = task_data.UserID;
...
void TdApi::processRspOrderInsert(Task task) {
  PyLock lock;
  CSgitFtdcInputOrderField task_data =
      any_cast<CSgitFtdcInputOrderField>(task.task_data);
  dict data;
...
void TdApi::processRspOrderAction(Task task) {
  PyLock lock;
  CSgitFtdcInputOrderActionField task_data =
      any_cast<CSgitFtdcInputOrderActionField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
...
void TdApi::processRspQryTradingAccount(Task task) {
  PyLock lock;
  CSgitFtdcTradingAccountField task_data =
      any_cast<CSgitFtdcTradingAccountField>(task.task_data);
  dict data;
...
void TdApi::processRspQryInvestor(Task task) {
  PyLock lock;
  CSgitFtdcInvestorField task_data =
      any_cast<CSgitFtdcInvestorField>(task.task_data);
  dict data;
...
void TdApi::processRspQryInstrument(Task task) {
  PyLock lock;
  CSgitFtdcInstrumentField task_data =
      any_cast<CSgitFtdcInstrumentField>(task.task_data);
  dict data;
...
void TdApi::processRtnInstrumentStatus(Task task) {
  PyLock lock;
  CSgitFtdcInstrumentStatusField task_data =
      any_cast<CSgitFtdcInstrumentStatusField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
...
void TdApi::processRspQryInvestorPositionDetail(Task task) {
  PyLock lock;
  CSgitFtdcInvestorPositionDetailField task_data =
      any_cast<CSgitFtdcInvestorPositionDetailField>(task.task_data);
  dict data;
...
void TdApi::processRspQryInvestorPosition(Task task) {
  PyLock lock;
  CSgitFtdcInvestorPositionField task_data =
      any_cast<CSgitFtdcInvestorPositionField>(task.task_data);
  dict data;
...
int TdApi::reqQryInvestorPositionDetail(dict req, int nRequestID) {
  CSgitFtdcQryInvestorPositionDetailField myreq =
