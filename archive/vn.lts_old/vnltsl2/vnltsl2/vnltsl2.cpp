...
void L2MdApi::OnRspError(CSecurityFtdcRspInfoField *pRspInfo, int nRequestID,
                         bool bIsLast) {
  Task task = Task();
...
void L2MdApi::OnRspUserLogin(CSecurityFtdcUserLoginField *pUserLogin,
...
void L2MdApi::OnRspUserLogout(CSecurityFtdcUserLogoutField *pUserLogout,
                              CSecurityFtdcRspInfoField *pRspInfo,
                              int nRequestID, bool bIsLast) {
  Task task = Task();
...
void L2MdApi::OnRspSubL2MarketData(
  ...
  if (pSpecificInstrument) {
    ...
    CSecurityFtdcSpecificInstrumentField empty_data =
...
void L2MdApi::OnRspUnSubL2MarketData(
    CSecurityFtdcSpecificInstrumentField *pSpecificInstrument,
    CSecurityFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
...
void L2MdApi::OnRspUnSubL2Index(
    CSecurityFtdcSpecificInstrumentField *pSpecificInstrument,
    CSecurityFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
...
void L2MdApi::OnRtnL2MarketData(CSecurityFtdcL2MarketDataField *pL2MarketData) {
  ...
  if (pL2MarketData) {
    ...
    CSecurityFtdcL2MarketDataField empty_data =
...
void L2MdApi::OnRspSubL2OrderAndTrade(CSecurityFtdcRspInfoField *pRspInfo,
                                      int nRequestID, bool bIsLast) {
  Task task = Task();
...
void L2MdApi::OnRspUnSubL2OrderAndTrade(CSecurityFtdcRspInfoField *pRspInfo,
                                        int nRequestID, bool bIsLast) {
  Task task = Task();
...
void L2MdApi::OnNtfCheckOrderList(TSecurityFtdcInstrumentIDType InstrumentID,
...
void L2MdApi::processRspUserLogin(Task task) {
  PyLock lock;
  CSecurityFtdcUserLoginField task_data =
      any_cast<CSecurityFtdcUserLoginField>(task.task_data);
  dict data;
...
void L2MdApi::processRspSubL2MarketData(Task task) {
  PyLock lock;
  CSecurityFtdcSpecificInstrumentField task_data =
      any_cast<CSecurityFtdcSpecificInstrumentField>(task.task_data);
  dict data;
...
void L2MdApi::processRtnL2MarketData(Task task) {
  PyLock lock;
  CSecurityFtdcL2MarketDataField task_data =
      any_cast<CSecurityFtdcL2MarketDataField>(task.task_data);
  dict data;
...
void L2MdApi::processRtnL2Index(Task task) {
  PyLock lock;
  CSecurityFtdcL2IndexField task_data =
      any_cast<CSecurityFtdcL2IndexField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
...
void L2MdApi::processRtnL2Order(Task task) {
  PyLock lock;
  CSecurityFtdcL2OrderField task_data =
      any_cast<CSecurityFtdcL2OrderField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
...
void L2MdApi::processRtnL2Trade(Task task) {
  PyLock lock;
  CSecurityFtdcL2TradeField task_data =
      any_cast<CSecurityFtdcL2TradeField>(task.task_data);
  dict data;
...
void L2MdApi::createFtdcL2MDUserApi(string pszFlowPath) {
  this->api =
      CSecurityFtdcL2MDUserApi::CreateFtdcL2MDUserApi(pszFlowPath.c_str());
  this->api->RegisterSpi(this);
};

void L2MdApi::release() { this->api->Release(); };

void L2MdApi::init() { this->api->Init(); };
...
struct L2MdApiWrap : L2MdApi, wrapper<L2MdApi> {
  ...
  virtual void onRspSubL2OrderAndTrade(dict data, dict error, int id,
                                       bool last) {
    try {
  ...
  virtual void onRspUnSubL2OrderAndTrade(dict data, dict error, int id,
                                         bool last) {
    try {
...
BOOST_PYTHON_MODULE(vnltsl2) {
  ...
  class_<L2MdApiWrap, boost::noncopyable>("L2MdApi")
      ...
      .def("unSubscribeL2OrderAndTrade",
           &L2MdApiWrap::unSubscribeL2OrderAndTrade)
      ...
      .def("onFrontDisconnected",
           pure_virtual(&L2MdApiWrap::onFrontDisconnected))
      ...
      .def("onRspSubL2MarketData",
           pure_virtual(&L2MdApiWrap::onRspSubL2MarketData))
      .def("onRspUnSubL2MarketData",
           pure_virtual(&L2MdApiWrap::onRspUnSubL2MarketData))
      ...
      .def("onRspSubL2OrderAndTrade",
           pure_virtual(&L2MdApiWrap::onRspSubL2OrderAndTrade))
      .def("onRspUnSubL2OrderAndTrade",
           pure_virtual(&L2MdApiWrap::onRspUnSubL2OrderAndTrade))
      .def("onRtnL2Order", pure_virtual(&L2MdApiWrap::onRtnL2Order))
      .def("onRtnL2Trade", pure_virtual(&L2MdApiWrap::onRtnL2Trade))
      .def("onNtfCheckOrderList",
           pure_virtual(&L2MdApiWrap::onNtfCheckOrderList));
};