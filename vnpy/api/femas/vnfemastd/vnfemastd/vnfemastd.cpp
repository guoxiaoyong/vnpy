...
void TdApi::OnRspError(CUstpFtdcRspInfoField *pRspInfo, int nRequestID,
                       bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspUserLogin(CUstpFtdcRspUserLoginField *pRspUserLogin,
...
void TdApi::OnRspUserLogout(CUstpFtdcRspUserLogoutField *pRspUserLogout,
                            CUstpFtdcRspInfoField *pRspInfo, int nRequestID,
                            bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspUserPasswordUpdate(
  ...
  if (pUserPasswordUpdate) {
    ...
    CUstpFtdcUserPasswordUpdateField empty_data =
...
void TdApi::OnRspOrderInsert(CUstpFtdcInputOrderField *pInputOrder,
                             CUstpFtdcRspInfoField *pRspInfo, int nRequestID,
                             bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspOrderAction(CUstpFtdcOrderActionField *pOrderAction,
                             CUstpFtdcRspInfoField *pRspInfo, int nRequestID,
                             bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRtnFlowMessageCancel(
  ...
  if (pFlowMessageCancel) {
    ...
    CUstpFtdcFlowMessageCancelField empty_data =
...
void TdApi::OnErrRtnOrderInsert(CUstpFtdcInputOrderField *pInputOrder,
...
void TdApi::OnErrRtnOrderAction(CUstpFtdcOrderActionField *pOrderAction,
                                CUstpFtdcRspInfoField *pRspInfo) {
  Task task = Task();
...
void TdApi::OnRtnInstrumentStatus(
  ...
  if (pInstrumentStatus) {
    ...
    CUstpFtdcInstrumentStatusField empty_data =
...
void TdApi::OnRtnInvestorAccountDeposit(
  ...
  if (pInvestorAccountDepositRes) {
    ...
    CUstpFtdcInvestorAccountDepositResField empty_data =
...
void TdApi::OnRspQryOrder(CUstpFtdcOrderField *pOrder,
                          CUstpFtdcRspInfoField *pRspInfo, int nRequestID,
                          bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryTrade(CUstpFtdcTradeField *pTrade,
                          CUstpFtdcRspInfoField *pRspInfo, int nRequestID,
                          bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryUserInvestor(
...
void TdApi::OnRspQryTradingCode(CUstpFtdcRspTradingCodeField *pRspTradingCode,
                                CUstpFtdcRspInfoField *pRspInfo, int nRequestID,
                                bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryInvestorAccount(
  ...
  if (pRspInvestorAccount) {
    ...
    CUstpFtdcRspInvestorAccountField empty_data =
...
void TdApi::OnRspQryInstrument(CUstpFtdcRspInstrumentField *pRspInstrument,
                               CUstpFtdcRspInfoField *pRspInfo, int nRequestID,
                               bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryExchange(CUstpFtdcRspExchangeField *pRspExchange,
                             CUstpFtdcRspInfoField *pRspInfo, int nRequestID,
                             bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryInvestorPosition(
  ...
  if (pRspInvestorPosition) {
    ...
    CUstpFtdcRspInvestorPositionField empty_data =
...
void TdApi::OnRspSubscribeTopic(CUstpFtdcDisseminationField *pDissemination,
                                CUstpFtdcRspInfoField *pRspInfo, int nRequestID,
                                bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryComplianceParam(
  ...
  if (pRspComplianceParam) {
    ...
    CUstpFtdcRspComplianceParamField empty_data =
...
void TdApi::OnRspQryTopic(CUstpFtdcDisseminationField *pDissemination,
                          CUstpFtdcRspInfoField *pRspInfo, int nRequestID,
                          bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryInvestorFee(CUstpFtdcInvestorFeeField *pInvestorFee,
                                CUstpFtdcRspInfoField *pRspInfo, int nRequestID,
                                bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryInvestorMargin(
...
void TdApi::processRspError(Task task) {
  PyLock lock;
  CUstpFtdcRspInfoField task_error =
      any_cast<CUstpFtdcRspInfoField>(task.task_error);
  dict error;
...
void TdApi::processRspUserLogin(Task task) {
  PyLock lock;
  CUstpFtdcRspUserLoginField task_data =
      any_cast<CUstpFtdcRspUserLoginField>(task.task_data);
  dict data;
...
void TdApi::processRspUserLogout(Task task) {
  PyLock lock;
  CUstpFtdcRspUserLogoutField task_data =
      any_cast<CUstpFtdcRspUserLogoutField>(task.task_data);
  dict data;
  data["UserID"] = task_data.UserID;
  data["BrokerID"] = task_data.BrokerID;
...
void TdApi::processRspUserPasswordUpdate(Task task) {
  PyLock lock;
  CUstpFtdcUserPasswordUpdateField task_data =
      any_cast<CUstpFtdcUserPasswordUpdateField>(task.task_data);
  dict data;
  data["UserID"] = task_data.UserID;
...
void TdApi::processRspOrderInsert(Task task) {
  PyLock lock;
  CUstpFtdcInputOrderField task_data =
      any_cast<CUstpFtdcInputOrderField>(task.task_data);
  dict data;
...
void TdApi::processRspOrderAction(Task task) {
  PyLock lock;
  CUstpFtdcOrderActionField task_data =
      any_cast<CUstpFtdcOrderActionField>(task.task_data);
  dict data;
  data["ExchangeID"] = task_data.ExchangeID;
...
void TdApi::processRtnFlowMessageCancel(Task task) {
  PyLock lock;
  CUstpFtdcFlowMessageCancelField task_data =
      any_cast<CUstpFtdcFlowMessageCancelField>(task.task_data);
  dict data;
  data["DataCenterID"] = task_data.DataCenterID;
  data["TradingDay"] = task_data.TradingDay;
...
void TdApi::processRtnInstrumentStatus(Task task) {
  PyLock lock;
  CUstpFtdcInstrumentStatusField task_data =
      any_cast<CUstpFtdcInstrumentStatusField>(task.task_data);
  dict data;
...
void TdApi::processRtnInvestorAccountDeposit(Task task) {
  PyLock lock;
  CUstpFtdcInvestorAccountDepositResField task_data =
      any_cast<CUstpFtdcInvestorAccountDepositResField>(task.task_data);
  dict data;
...
void TdApi::processRspQryUserInvestor(Task task) {
  PyLock lock;
  CUstpFtdcRspUserInvestorField task_data =
      any_cast<CUstpFtdcRspUserInvestorField>(task.task_data);
  dict data;
  data["UserID"] = task_data.UserID;
  data["BrokerID"] = task_data.BrokerID;
  data["InvestorID"] = task_data.InvestorID;
...
void TdApi::processRspQryTradingCode(Task task) {
  PyLock lock;
  CUstpFtdcRspTradingCodeField task_data =
      any_cast<CUstpFtdcRspTradingCodeField>(task.task_data);
  dict data;
  data["ExchangeID"] = task_data.ExchangeID;
  data["ClientID"] = task_data.ClientID;
  data["InvestorID"] = task_data.InvestorID;
...
void TdApi::processRspQryInvestorAccount(Task task) {
  PyLock lock;
  CUstpFtdcRspInvestorAccountField task_data =
      any_cast<CUstpFtdcRspInvestorAccountField>(task.task_data);
  dict data;
...
void TdApi::processRspQryInstrument(Task task) {
  PyLock lock;
  CUstpFtdcRspInstrumentField task_data =
      any_cast<CUstpFtdcRspInstrumentField>(task.task_data);
  dict data;
  data["IsTrading"] = task_data.IsTrading;
  data["ExpireDate"] = task_data.ExpireDate;
  data["StrikePrice"] = task_data.StrikePrice;
...
void TdApi::processRspQryExchange(Task task) {
  PyLock lock;
  CUstpFtdcRspExchangeField task_data =
      any_cast<CUstpFtdcRspExchangeField>(task.task_data);
  dict data;
  data["ExchangeID"] = task_data.ExchangeID;
...
void TdApi::processRspQryInvestorPosition(Task task) {
  PyLock lock;
  CUstpFtdcRspInvestorPositionField task_data =
      any_cast<CUstpFtdcRspInvestorPositionField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
  data["FrozenPremium"] = task_data.FrozenPremium;
...
void TdApi::processRspSubscribeTopic(Task task) {
  PyLock lock;
  CUstpFtdcDisseminationField task_data =
      any_cast<CUstpFtdcDisseminationField>(task.task_data);
  dict data;
...
void TdApi::processRspQryComplianceParam(Task task) {
  PyLock lock;
  CUstpFtdcRspComplianceParamField task_data =
      any_cast<CUstpFtdcRspComplianceParamField>(task.task_data);
  dict data;
  data["ExchangeID"] = task_data.ExchangeID;
...
void TdApi::processRspQryInvestorFee(Task task) {
  PyLock lock;
  CUstpFtdcInvestorFeeField task_data =
      any_cast<CUstpFtdcInvestorFeeField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
...
void TdApi::processRspQryInvestorMargin(Task task) {
  ...
  CUstpFtdcInvestorMarginField task_data =
      any_cast<CUstpFtdcInvestorMarginField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
...
int TdApi::registerCertificateFile(string pszCertFileName,
                                   string pszKeyFileName, string pszCaFileName,
                                   string pszKeyFilePassword) {
  int i = this->api->RegisterCertificateFile(
      pszCertFileName.c_str(), pszKeyFileName.c_str(), pszCaFileName.c_str(),
      pszKeyFilePassword.c_str());
  return i;
}
...
struct TdApiWrap : TdApi, wrapper<TdApi> {
  ...
  virtual void onRspQryComplianceParam(dict data, dict error, int id,
                                       bool last) {
    try {
...
BOOST_PYTHON_MODULE(vnfemastd) {
  ...
  class_<TdApiWrap, boost::noncopyable>("TdApi")
      ...
      .def("onRspQryComplianceParam",
           pure_virtual(&TdApiWrap::onRspQryComplianceParam))
