...
void TdApi::OnRspError(CKSOTPRspInfoField *pRspInfo, int nRequestID,
                       bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspUserLogin(CKSOTPRspUserLoginField *pRspUserLogin,
...
void TdApi::OnRspUserLogout(CKSOTPUserLogoutField *pUserLogout,
                            CKSOTPRspInfoField *pRspInfo, int nRequestID,
                            bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspUserPasswordUpdate(
    CKSOTPUserPasswordUpdateField *pUserPasswordUpdate,
...
void TdApi::OnRspTradingAccountPasswordUpdate(
  ...
  if (pTradingAccountPasswordUpdate) {
    ...
    CKSOTPTradingAccountPasswordUpdateField empty_data =
...
void TdApi::OnRspOrderInsert(CKSOTPInputOrderField *pInputOrder,
                             CKSOTPRspInfoField *pRspInfo, int nRequestID,
                             bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspOrderAction(CKSOTPInputOrderActionField *pInputOrderAction,
                             CKSOTPRspInfoField *pRspInfo, int nRequestID,
                             bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryOrder(CKSOTPOrderField *pOrder,
                          CKSOTPRspInfoField *pRspInfo, int nRequestID,
                          bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryTrade(CKSOTPTradeField *pTrade,
                          CKSOTPRspInfoField *pRspInfo, int nRequestID,
                          bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryInvestorPosition(
    CKSOTPInvestorPositionField *pInvestorPosition,
    CKSOTPRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryTradingAccount(CKSOTPTradingAccountField *pTradingAccount,
                                   CKSOTPRspInfoField *pRspInfo, int nRequestID,
                                   bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryInvestor(CKSOTPInvestorField *pInvestor,
                             CKSOTPRspInfoField *pRspInfo, int nRequestID,
                             bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryTradingCode(CKSOTPTradingCodeField *pTradingCode,
                                CKSOTPRspInfoField *pRspInfo, int nRequestID,
                                bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryExchange(CKSOTPExchangeField *pExchange,
                             CKSOTPRspInfoField *pRspInfo, int nRequestID,
                             bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryInstrument(CKSOTPInstrumentField *pInstrument,
                               CKSOTPRspInfoField *pRspInfo, int nRequestID,
                               bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryInvestorPositionDetail(
  ...
  if (pInvestorPositionDetail) {
    ...
    CKSOTPInvestorPositionDetailField empty_data =
...
void TdApi::OnRspQryTradingNotice(CKSOTPTradingNoticeField *pTradingNotice,
                                  CKSOTPRspInfoField *pRspInfo, int nRequestID,
                                  bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspExecOrderInsert(CKSOTPInputExecOrderField *pInputExecOrder,
                                 CKSOTPRspInfoField *pRspInfo, int nRequestID,
                                 bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspLockInsert(CKSOTPInputLockField *pInputLock,
                            CKSOTPRspInfoField *pRspInfo, int nRequestID,
                            bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspExecOrderAction(
    CKSOTPInputExecOrderActionField *pInputExecOrderAction,
    CKSOTPRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
  ...
  if (pInputExecOrderAction) {
    ...
    CKSOTPInputExecOrderActionField empty_data =
...
void TdApi::OnRspQryExecOrder(CKSOTPExecOrderField *pExecOrder,
                              CKSOTPRspInfoField *pRspInfo, int nRequestID,
                              bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryExecOrderVolume(
    CKSOTPExecOrderVolumeField *pExecOrderVolume, CKSOTPRspInfoField *pRspInfo,
...
void TdApi::OnRspQryLock(CKSOTPLockField *pLock, CKSOTPRspInfoField *pRspInfo,
                         int nRequestID, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryLockPosition(CKSOTPLockPositionField *pLockPosition,
                                 CKSOTPRspInfoField *pRspInfo, int nRequestID,
                                 bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryUnderlyingStockInfo(
  ...
  if (pUnderlyingStockInfo) {
    ...
    CKSOTPUnderlyingStockInfoField empty_data =
...
void TdApi::OnRspQryOTPInsCommRate(CKSOTPOTPInsCommRateField *pOTPInsCommRate,
                                   CKSOTPRspInfoField *pRspInfo, int nRequestID,
                                   bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryInstrumentMarginRate(
  ...
  if (pInstrumentMarginRate) {
    ...
    CKSOTPInstrumentMarginRateField empty_data =
...
void TdApi::OnRspQryOTPAssignment(CKSOTPOTPAssignmentField *pOTPAssignment,
                                  CKSOTPRspInfoField *pRspInfo, int nRequestID,
                                  bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryDepthMarketData(
    CKSOTPDepthMarketDataField *pDepthMarketData, CKSOTPRspInfoField *pRspInfo,
    int nRequestID, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspFromBankToStockByStock(CKSOTPReqTransferField *pReqTransfer,
...
void TdApi::OnRspFromStockToBankByStock(CKSOTPReqTransferField *pReqTransfer,
                                        CKSOTPRspInfoField *pRspInfo,
                                        int nRequestID, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRtnQueryBankBalanceByStock(
...
void TdApi::OnRspQryContractBank(CKSOTPContractBankField *pContractBank,
                                 CKSOTPRspInfoField *pRspInfo, int nRequestID,
                                 bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQueryBankAccountMoneyByStock(
    CKSOTPReqQueryAccountField *pReqQueryAccount, CKSOTPRspInfoField *pRspInfo,
    int nRequestID, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryTransferSerial(CKSOTPTransferSerialField *pTransferSerial,
                                   CKSOTPRspInfoField *pRspInfo, int nRequestID,
                                   bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQrySettlementInfoConfirm(
  ...
  if (pSettlementInfoConfirm) {
    ...
    CKSOTPSettlementInfoConfirmField empty_data =
...
void TdApi::OnRspQrySettlementInfo(CKSOTPSettlementInfoField *pSettlementInfo,
                                   CKSOTPRspInfoField *pRspInfo, int nRequestID,
                                   bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryInvestorTradeLevel(
    CKSOTPInvestorTradeLevelField *pInvestorTradeLevel,
    CKSOTPRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryPurchaseLimitAmt(
    CKSOTPPurchaseLimitAmtField *pPurchaseLimitAmt,
    CKSOTPRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryPositionLimitVol(
    CKSOTPPositionLimitVolField *pPositionLimitVol,
    CKSOTPRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryHistoryOrder(CKSOTPHistoryOrderField *pHistoryOrder,
                                 CKSOTPRspInfoField *pRspInfo, int nRequestID,
                                 bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryHistoryTrade(CKSOTPHistoryTradeField *pHistoryTrade,
                                 CKSOTPRspInfoField *pRspInfo, int nRequestID,
                                 bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryHistoryAssignment(
    CKSOTPHistoryAssignmentField *pHistoryAssignment,
    CKSOTPRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryDelivDetail(CKSOTPDelivDetailField *pDelivDetail,
                                CKSOTPRspInfoField *pRspInfo, int nRequestID,
                                bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspAutoExecOrderAction(
    CKSOTPAutoExecOrderActionField *pAutoExecOrderAction,
    CKSOTPRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
  ...
  if (pAutoExecOrderAction) {
    ...
    CKSOTPAutoExecOrderActionField empty_data =
...
void TdApi::OnRspCombActionInsert(CKSOTPInputCombActionField *pInputCombAction,
                                  CKSOTPRspInfoField *pRspInfo, int nRequestID,
                                  bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryInvestorCombinePosition(
  ...
  if (pInvestorPositionCombineDetail) {
    ...
    CKSOTPInvestorPositionCombineDetailField empty_data =
...
void TdApi::OnRspQryCombActionVolume(
    CKSOTPCombActionVolumeField *pCombActionVolume,
    CKSOTPRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspFundOutCreditApply(
  ...
  if (pFundOutCreditApply) {
    ...
    CKSOTPInputFundOutCreditApplyField empty_data =
...
void TdApi::OnRspQryFundOutCredit(
    CKSOTPRspQryFundOutCreditField *pRspQryFundOutCredit,
    CKSOTPRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
  ...
  if (pRspQryFundOutCredit) {
    ...
    CKSOTPRspQryFundOutCreditField empty_data =
...
void TdApi::OnRspQryFundOutCreditApply(
  ...
  if (pRspQryFundOutCreditApply) {
    ...
    CKSOTPRspQryFundOutCreditApplyField empty_data =
...
void TdApi::OnRtnInstrumentStatus(
    CKSOTPInstrumentStatusField *pInstrumentStatus) {
  Task task = Task();
...
void TdApi::OnRtnTradingNotice(
    CKSOTPTradingNoticeInfoField *pTradingNoticeInfo) {
  Task task = Task();
...
void TdApi::processRspUserLogin(Task task) {
  PyLock lock;
  CKSOTPRspUserLoginField task_data =
      any_cast<CKSOTPRspUserLoginField>(task.task_data);
  dict data;
...
void TdApi::processRspUserLogout(Task task) {
  PyLock lock;
  CKSOTPUserLogoutField task_data =
      any_cast<CKSOTPUserLogoutField>(task.task_data);
  dict data;
  data["UserID"] = task_data.UserID;
  data["BrokerID"] = task_data.BrokerID;
...
void TdApi::processRspUserPasswordUpdate(Task task) {
  PyLock lock;
  CKSOTPUserPasswordUpdateField task_data =
      any_cast<CKSOTPUserPasswordUpdateField>(task.task_data);
  dict data;
  data["UserID"] = task_data.UserID;
...
void TdApi::processRspTradingAccountPasswordUpdate(Task task) {
  PyLock lock;
  CKSOTPTradingAccountPasswordUpdateField task_data =
      any_cast<CKSOTPTradingAccountPasswordUpdateField>(task.task_data);
  dict data;
  data["NewPassword"] = task_data.NewPassword;
  data["OldPassword"] = task_data.OldPassword;
  data["BrokerID"] = task_data.BrokerID;
...
void TdApi::processRspOrderInsert(Task task) {
  PyLock lock;
  CKSOTPInputOrderField task_data =
      any_cast<CKSOTPInputOrderField>(task.task_data);
  dict data;
...
void TdApi::processRspOrderAction(Task task) {
  PyLock lock;
  CKSOTPInputOrderActionField task_data =
      any_cast<CKSOTPInputOrderActionField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
...
void TdApi::processRspQryInvestorPosition(Task task) {
  PyLock lock;
  CKSOTPInvestorPositionField task_data =
      any_cast<CKSOTPInvestorPositionField>(task.task_data);
  dict data;
...
void TdApi::processRspQryTradingAccount(Task task) {
  PyLock lock;
  CKSOTPTradingAccountField task_data =
      any_cast<CKSOTPTradingAccountField>(task.task_data);
  dict data;
...
void TdApi::processRspQryTradingCode(Task task) {
  PyLock lock;
  CKSOTPTradingCodeField task_data =
      any_cast<CKSOTPTradingCodeField>(task.task_data);
  dict data;
  data["ExchangeID"] = task_data.ExchangeID;
  data["ClientID"] = task_data.ClientID;
  data["InvestorID"] = task_data.InvestorID;
...
void TdApi::processRspQryInstrument(Task task) {
  PyLock lock;
  CKSOTPInstrumentField task_data =
      any_cast<CKSOTPInstrumentField>(task.task_data);
  dict data;
...
void TdApi::processRspQryInvestorPositionDetail(Task task) {
  PyLock lock;
  CKSOTPInvestorPositionDetailField task_data =
      any_cast<CKSOTPInvestorPositionDetailField>(task.task_data);
  dict data;
...
void TdApi::processRspQryTradingNotice(Task task) {
  PyLock lock;
  CKSOTPTradingNoticeField task_data =
      any_cast<CKSOTPTradingNoticeField>(task.task_data);
  dict data;
...
void TdApi::processRspExecOrderInsert(Task task) {
  PyLock lock;
  CKSOTPInputExecOrderField task_data =
      any_cast<CKSOTPInputExecOrderField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
...
void TdApi::processRspLockInsert(Task task) {
  PyLock lock;
  CKSOTPInputLockField task_data =
      any_cast<CKSOTPInputLockField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
  data["BusinessUnit"] = task_data.BusinessUnit;
...
void TdApi::processRspExecOrderAction(Task task) {
  PyLock lock;
  CKSOTPInputExecOrderActionField task_data =
      any_cast<CKSOTPInputExecOrderActionField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
...
void TdApi::processRspQryExecOrder(Task task) {
  PyLock lock;
  CKSOTPExecOrderField task_data =
      any_cast<CKSOTPExecOrderField>(task.task_data);
  dict data;
  data["NotifySequence"] = task_data.NotifySequence;
  data["CloseFlag"] = task_data.CloseFlag;
  data["ActiveUserID"] = task_data.ActiveUserID;
...
void TdApi::processRspQryExecOrderVolume(Task task) {
  PyLock lock;
  CKSOTPExecOrderVolumeField task_data =
      any_cast<CKSOTPExecOrderVolumeField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["Direction"] = task_data.Direction;
  data["HedgeFlag"] = task_data.HedgeFlag;
...
void TdApi::processRspQryLockPosition(Task task) {
  PyLock lock;
  CKSOTPLockPositionField task_data =
      any_cast<CKSOTPLockPositionField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
...
void TdApi::processRspQryUnderlyingStockInfo(Task task) {
  PyLock lock;
  CKSOTPUnderlyingStockInfoField task_data =
      any_cast<CKSOTPUnderlyingStockInfoField>(task.task_data);
  dict data;
...
void TdApi::processRspQryOTPInsCommRate(Task task) {
  PyLock lock;
  CKSOTPOTPInsCommRateField task_data =
      any_cast<CKSOTPOTPInsCommRateField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
...
void TdApi::processRspQryInstrumentMarginRate(Task task) {
  PyLock lock;
  CKSOTPInstrumentMarginRateField task_data =
      any_cast<CKSOTPInstrumentMarginRateField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
...
void TdApi::processRspQryOTPAssignment(Task task) {
  PyLock lock;
  CKSOTPOTPAssignmentField task_data =
      any_cast<CKSOTPOTPAssignmentField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["InstrumentName"] = task_data.InstrumentName;
  data["Direction"] = task_data.Direction;
...
void TdApi::processRspQryDepthMarketData(Task task) {
  PyLock lock;
  CKSOTPDepthMarketDataField task_data =
      any_cast<CKSOTPDepthMarketDataField>(task.task_data);
  dict data;
...
void TdApi::processRspFromBankToStockByStock(Task task) {
  PyLock lock;
  CKSOTPReqTransferField task_data =
      any_cast<CKSOTPReqTransferField>(task.task_data);
  dict data;
...
void TdApi::processRtnFromBankToStockByStock(Task task) {
  PyLock lock;
  CKSOTPRspTransferField task_data =
      any_cast<CKSOTPRspTransferField>(task.task_data);
  dict data;
  data["BrokerBranchID"] = task_data.BrokerBranchID;
  data["UserID"] = task_data.UserID;
  data["BankPassWord"] = task_data.BankPassWord;
...
void TdApi::processRtnQueryBankBalanceByStock(Task task) {
  PyLock lock;
  CKSOTPNotifyQueryAccountField task_data =
      any_cast<CKSOTPNotifyQueryAccountField>(task.task_data);
  dict data;
  data["BrokerBranchID"] = task_data.BrokerBranchID;
  data["UserID"] = task_data.UserID;
  data["BankPassWord"] = task_data.BankPassWord;
...
void TdApi::processRspQryContractBank(Task task) {
  PyLock lock;
  CKSOTPContractBankField task_data =
      any_cast<CKSOTPContractBankField>(task.task_data);
  dict data;
...
void TdApi::processRspQueryBankAccountMoneyByStock(Task task) {
  PyLock lock;
  CKSOTPReqQueryAccountField task_data =
      any_cast<CKSOTPReqQueryAccountField>(task.task_data);
  dict data;
  data["BrokerBranchID"] = task_data.BrokerBranchID;
  data["UserID"] = task_data.UserID;
  data["BankPassWord"] = task_data.BankPassWord;
  ...
  this->onRspQueryBankAccountMoneyByStock(data, error, task.task_id,
                                          task.task_last);
};

void TdApi::processRspQryTransferSerial(Task task) {
  PyLock lock;
  CKSOTPTransferSerialField task_data =
      any_cast<CKSOTPTransferSerialField>(task.task_data);
  dict data;
...
void TdApi::processRspQrySettlementInfoConfirm(Task task) {
  PyLock lock;
  CKSOTPSettlementInfoConfirmField task_data =
      any_cast<CKSOTPSettlementInfoConfirmField>(task.task_data);
  dict data;
...
void TdApi::processRspQrySettlementInfo(Task task) {
  PyLock lock;
  CKSOTPSettlementInfoField task_data =
      any_cast<CKSOTPSettlementInfoField>(task.task_data);
  dict data;
  data["SettlementID"] = task_data.SettlementID;
  data["InvestorID"] = task_data.InvestorID;
  data["SequenceNo"] = task_data.SequenceNo;
...
void TdApi::processRspQryInvestorTradeLevel(Task task) {
  PyLock lock;
  CKSOTPInvestorTradeLevelField task_data =
      any_cast<CKSOTPInvestorTradeLevelField>(task.task_data);
  dict data;
  data["InvestorID"] = task_data.InvestorID;
  data["ExchangeID"] = task_data.ExchangeID;
  data["BrokerID"] = task_data.BrokerID;
...
void TdApi::processRspQryPurchaseLimitAmt(Task task) {
  PyLock lock;
  CKSOTPPurchaseLimitAmtField task_data =
      any_cast<CKSOTPPurchaseLimitAmtField>(task.task_data);
  dict data;
  data["InvestorID"] = task_data.InvestorID;
  data["ExchangeID"] = task_data.ExchangeID;
...
void TdApi::processRspQryPositionLimitVol(Task task) {
  PyLock lock;
  CKSOTPPositionLimitVolField task_data =
      any_cast<CKSOTPPositionLimitVolField>(task.task_data);
  dict data;
...
void TdApi::processRspQryHistoryOrder(Task task) {
  PyLock lock;
  CKSOTPHistoryOrderField task_data =
      any_cast<CKSOTPHistoryOrderField>(task.task_data);
  dict data;
  data["VolumeTraded"] = task_data.VolumeTraded;
  data["UserProductInfo"] = task_data.UserProductInfo;
  data["ProductClass"] = task_data.ProductClass;
...
void TdApi::processRspQryHistoryTrade(Task task) {
  PyLock lock;
  CKSOTPHistoryTradeField task_data =
      any_cast<CKSOTPHistoryTradeField>(task.task_data);
  dict data;
  data["VolumeTraded"] = task_data.VolumeTraded;
  data["HedgeFlag"] = task_data.HedgeFlag;
  data["Commission"] = task_data.Commission;
...
void TdApi::processRspQryHistoryAssignment(Task task) {
  PyLock lock;
  CKSOTPHistoryAssignmentField task_data =
      any_cast<CKSOTPHistoryAssignmentField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["OptionsType"] = task_data.OptionsType;
...
void TdApi::processRspQryDelivDetail(Task task) {
  PyLock lock;
  CKSOTPDelivDetailField task_data =
      any_cast<CKSOTPDelivDetailField>(task.task_data);
  dict data;
  data["ExchangeID"] = task_data.ExchangeID;
  data["FunctionName"] = task_data.FunctionName;
...
void TdApi::processRspAutoExecOrderAction(Task task) {
  PyLock lock;
  CKSOTPAutoExecOrderActionField task_data =
      any_cast<CKSOTPAutoExecOrderActionField>(task.task_data);
  dict data;
  data["InvestorID"] = task_data.InvestorID;
  data["BrokerID"] = task_data.BrokerID;
...
void TdApi::processRspCombActionInsert(Task task) {
  PyLock lock;
  CKSOTPInputCombActionField task_data =
      any_cast<CKSOTPInputCombActionField>(task.task_data);
  dict data;
  data["ExchangeID"] = task_data.ExchangeID;
...
void TdApi::processRspQryInvestorCombinePosition(Task task) {
  PyLock lock;
  CKSOTPInvestorPositionCombineDetailField task_data =
      any_cast<CKSOTPInvestorPositionCombineDetailField>(task.task_data);
  dict data;
  data["ExchangeID"] = task_data.ExchangeID;
  ...
  this->onRspQryInvestorCombinePosition(data, error, task.task_id,
                                        task.task_last);
};

void TdApi::processRspQryCombActionVolume(Task task) {
  PyLock lock;
  CKSOTPCombActionVolumeField task_data =
      any_cast<CKSOTPCombActionVolumeField>(task.task_data);
  dict data;
  data["InvestorID"] = task_data.InvestorID;
  data["BrokerID"] = task_data.BrokerID;
...
void TdApi::processRspFundOutCreditApply(Task task) {
  PyLock lock;
  CKSOTPInputFundOutCreditApplyField task_data =
      any_cast<CKSOTPInputFundOutCreditApplyField>(task.task_data);
  dict data;
...
void TdApi::processRspQryFundOutCredit(Task task) {
  PyLock lock;
  CKSOTPRspQryFundOutCreditField task_data =
      any_cast<CKSOTPRspQryFundOutCreditField>(task.task_data);
  dict data;
  data["FundOutCredit"] = task_data.FundOutCredit;
...
void TdApi::processRspQryFundOutCreditApply(Task task) {
  PyLock lock;
  CKSOTPRspQryFundOutCreditApplyField task_data =
      any_cast<CKSOTPRspQryFundOutCreditApplyField>(task.task_data);
  dict data;
...
void TdApi::processRtnInstrumentStatus(Task task) {
  PyLock lock;
  CKSOTPInstrumentStatusField task_data =
      any_cast<CKSOTPInstrumentStatusField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
...
void TdApi::processRtnTradingNotice(Task task) {
  PyLock lock;
  CKSOTPTradingNoticeInfoField task_data =
      any_cast<CKSOTPTradingNoticeInfoField>(task.task_data);
  dict data;
  data["SequenceSeries"] = task_data.SequenceSeries;
  data["SequenceNo"] = task_data.SequenceNo;
  data["FieldContent"] = task_data.FieldContent;
...
void TdApi::processRtnCombAction(Task task) {
  PyLock lock;
  CKSOTPCombActionField task_data =
      any_cast<CKSOTPCombActionField>(task.task_data);
  dict data;
  data["NotifySequence"] = task_data.NotifySequence;
  data["ComTradeID"] = task_data.ComTradeID;
  data["UserProductInfo"] = task_data.UserProductInfo;
...
int TdApi::reqTradingAccountPasswordUpdate(dict req, int nRequestID) {
  CKSOTPTradingAccountPasswordUpdateField myreq =
      CKSOTPTradingAccountPasswordUpdateField();
  memset(&myreq, 0, sizeof(myreq));
  getChar(req, "NewPassword", myreq.NewPassword);
  getChar(req, "OldPassword", myreq.OldPassword);
...
int TdApi::reqQryInvestorPositionDetail(dict req, int nRequestID) {
  CKSOTPQryInvestorPositionDetailField myreq =
...
int TdApi::reqQryInstrumentMarginRate(dict req, int nRequestID) {
  CKSOTPQryInstrumentMarginRateField myreq =
...
int TdApi::reqQrySettlementInfoConfirm(dict req, int nRequestID) {
  CKSOTPQrySettlementInfoConfirmField myreq =
...
int TdApi::reqQryInvestorCombinePosition(dict req, int nRequestID) {
  CKSOTPQryInvestorPositionCombineDetailField myreq =
...
int TdApi::reqFundOutCreditApply(dict req, int nRequestID) {
  CKSOTPInputFundOutCreditApplyField myreq =
      CKSOTPInputFundOutCreditApplyField();
  memset(&myreq, 0, sizeof(myreq));
...
struct TdApiWrap : TdApi, wrapper<TdApi> {
  ...
  virtual void onRspQueryBankAccountMoneyByStock(dict data, dict error, int id,
                                                 bool last) {
    try {
      this->get_override("onRspQueryBankAccountMoneyByStock")(data, error, id,
                                                              last);
    } catch (error_already_set const &) {
      PyErr_Print();
    }
  ...
  virtual void onRspQryInvestorCombinePosition(dict data, dict error, int id,
                                               bool last) {
    try {
      this->get_override("onRspQryInvestorCombinePosition")(data, error, id,
                                                            last);
    } catch (error_already_set const &) {
      PyErr_Print();
    }
...
BOOST_PYTHON_MODULE(vnksotptd) {
  ...
  class_<TdApiWrap, boost::noncopyable>("TdApi")
      ...
      .def("reqQueryBankAccountMoneyByStock",
      ...
      .def("reqQryInvestorCombinePosition",
           &TdApiWrap::reqQryInvestorCombinePosition)
      ...
      .def("onRspQryExecOrderVolume",
           pure_virtual(&TdApiWrap::onRspQryExecOrderVolume))
      .def("onRspQryLock", pure_virtual(&TdApiWrap::onRspQryLock))
      .def("onRspQryLockPosition",
           pure_virtual(&TdApiWrap::onRspQryLockPosition))
      .def("onRspQryUnderlyingStockInfo",
           pure_virtual(&TdApiWrap::onRspQryUnderlyingStockInfo))
      .def("onRspQryOTPInsCommRate",
           pure_virtual(&TdApiWrap::onRspQryOTPInsCommRate))
      .def("onRspQryInstrumentMarginRate",
           pure_virtual(&TdApiWrap::onRspQryInstrumentMarginRate))
      .def("onRspQryOTPAssignment",
           pure_virtual(&TdApiWrap::onRspQryOTPAssignment))
      .def("onRspQryDepthMarketData",
           pure_virtual(&TdApiWrap::onRspQryDepthMarketData))
      .def("onRspFromBankToStockByStock",
           pure_virtual(&TdApiWrap::onRspFromBankToStockByStock))
      .def("onRtnFromBankToStockByStock",
           pure_virtual(&TdApiWrap::onRtnFromBankToStockByStock))
      .def("onRspFromStockToBankByStock",
           pure_virtual(&TdApiWrap::onRspFromStockToBankByStock))
      .def("onRtnFromStockToBankByStock",
           pure_virtual(&TdApiWrap::onRtnFromStockToBankByStock))
      .def("onRtnQueryBankBalanceByStock",
           pure_virtual(&TdApiWrap::onRtnQueryBankBalanceByStock))
      .def("onRspQryContractBank",
           pure_virtual(&TdApiWrap::onRspQryContractBank))
      .def("onRspQueryBankAccountMoneyByStock",
           pure_virtual(&TdApiWrap::onRspQueryBankAccountMoneyByStock))
      ...
      .def("onRspQryInvestorTradeLevel",
           pure_virtual(&TdApiWrap::onRspQryInvestorTradeLevel))
      .def("onRspQryPurchaseLimitAmt",
           pure_virtual(&TdApiWrap::onRspQryPurchaseLimitAmt))
      .def("onRspQryPositionLimitVol",
           pure_virtual(&TdApiWrap::onRspQryPositionLimitVol))
      .def("onRspQryHistoryOrder",
           pure_virtual(&TdApiWrap::onRspQryHistoryOrder))
      .def("onRspQryHistoryTrade",
           pure_virtual(&TdApiWrap::onRspQryHistoryTrade))
      .def("onRspQryHistoryAssignment",
           pure_virtual(&TdApiWrap::onRspQryHistoryAssignment))
      .def("onRspQryDelivDetail", pure_virtual(&TdApiWrap::onRspQryDelivDetail))
      .def("onRspAutoExecOrderAction",
           pure_virtual(&TdApiWrap::onRspAutoExecOrderAction))
      .def("onRspCombActionInsert",
           pure_virtual(&TdApiWrap::onRspCombActionInsert))
      .def("onRspQryInvestorCombinePosition",
           pure_virtual(&TdApiWrap::onRspQryInvestorCombinePosition))
      .def("onRspQryCombActionVolume",
           pure_virtual(&TdApiWrap::onRspQryCombActionVolume))
      .def("onRspFundOutCreditApply",
           pure_virtual(&TdApiWrap::onRspFundOutCreditApply))
      .def("onRspQryFundOutCredit",
           pure_virtual(&TdApiWrap::onRspQryFundOutCredit))
      .def("onRspQryFundOutCreditApply",
           pure_virtual(&TdApiWrap::onRspQryFundOutCreditApply))
      .def("onRspError", pure_virtual(&TdApiWrap::onRspError))
