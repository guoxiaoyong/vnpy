...
void TdApi::OnRspUserLogin(struct DFITCUserLoginInfoRtnField *pUserLoginInfoRtn,
...
void TdApi::OnRspUserLogout(
    struct DFITCUserLogoutInfoRtnField *pUserLogoutInfoRtn,
    struct DFITCErrorRtnField *pErrorInfo) {
  Task task = Task();
...
void TdApi::OnRspInsertOrder(struct DFITCOrderRspDataRtnField *pOrderRtn,
                             struct DFITCErrorRtnField *pErrorInfo) {
  Task task = Task();
...
void TdApi::OnRspCancelOrder(
    struct DFITCOrderRspDataRtnField *pOrderCanceledRtn,
    struct DFITCErrorRtnField *pErrorInfo) {
  Task task = Task();
...
void TdApi::OnRtnCancelOrder(
    struct DFITCOrderCanceledRtnField *pCancelOrderData) {
  Task task = Task();
...
void TdApi::OnRspQryOrderInfo(struct DFITCOrderCommRtnField *pRtnOrderData,
                              struct DFITCErrorRtnField *pErrorInfo,
                              bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryMatchInfo(struct DFITCMatchedRtnField *pRtnMatchData,
                              struct DFITCErrorRtnField *pErrorInfo,
                              bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryPosition(struct DFITCPositionInfoRtnField *pPositionInfoRtn,
                             struct DFITCErrorRtnField *pErrorInfo,
                             bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspCustomerCapital(
    struct DFITCCapitalInfoRtnField *pCapitalInfoRtn,
...
void TdApi::OnRspQryExchangeInstrument(
    struct DFITCExchangeInstrumentRtnField *pInstrumentData,
    struct DFITCErrorRtnField *pErrorInfo, bool bIsLast) {
  Task task = Task();
  ...
  if (pInstrumentData) {
    ...
    DFITCExchangeInstrumentRtnField empty_data =
...
void TdApi::OnRspArbitrageInstrument(
    struct DFITCAbiInstrumentRtnField *pAbiInstrumentData,
    struct DFITCErrorRtnField *pErrorInfo, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQrySpecifyInstrument(
    struct DFITCInstrumentRtnField *pInstrument,
    struct DFITCErrorRtnField *pErrorInfo, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryPositionDetail(
    struct DFITCPositionDetailRtnField *pPositionDetailRtn,
    struct DFITCErrorRtnField *pErrorInfo, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRtnTradingNotice(
    struct DFITCTradingNoticeInfoField *pTradingNoticeInfo) {
  Task task = Task();
...
void TdApi::OnRspResetPassword(struct DFITCResetPwdRspField *pResetPassword,
                               struct DFITCErrorRtnField *pErrorInfo) {
  Task task = Task();
...
void TdApi::OnRspQryTradeCode(struct DFITCQryTradeCodeRtnField *pTradeCode,
                              struct DFITCErrorRtnField *pErrorInfo,
                              bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspBillConfirm(struct DFITCBillConfirmRspField *pBillConfirm,
                             struct DFITCErrorRtnField *pErrorInfo) {
  Task task = Task();
...
void TdApi::OnRspEquityComputMode(
    struct DFITCEquityComputModeRtnField *pEquityComputMode) {
  Task task = Task();
...
void TdApi::OnRspQryBill(struct DFITCQryBillRtnField *pQryBill,
                         struct DFITCErrorRtnField *pErrorInfo, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspConfirmProductInfo(
    struct DFITCProductRtnField *pProductRtnData) {
  Task task = Task();
...
void TdApi::OnRspTradingDay(
    struct DFITCTradingDayRtnField *pTradingDayRtnData) {
  Task task = Task();
...
void TdApi::OnRspQuoteInsert(struct DFITCQuoteRspField *pRspQuoteData,
                             struct DFITCErrorRtnField *pErrorInfo) {
  Task task = Task();
...
void TdApi::OnRspQuoteCancel(struct DFITCQuoteRspField *pRspQuoteCanceledData,
                             struct DFITCErrorRtnField *pErrorInfo) {
  Task task = Task();
...
void TdApi::OnRtnQuoteCancel(
    struct DFITCQuoteCanceledRtnField *pRtnQuoteCanceledData) {
  Task task = Task();
...
void TdApi::OnRtnQuoteMatchedInfo(
    struct DFITCQuoteMatchRtnField *pRtnQuoteMatchedData) {
  Task task = Task();
...
void TdApi::OnRspCancelAllOrder(
    struct DFITCCancelAllOrderRspField *pRspCancelAllOrderData,
    struct DFITCErrorRtnField *pErrorInfo) {
  Task task = Task();
...
void TdApi::OnRspQryQuoteNotice(
    struct DFITCQryQuoteNoticeRtnField *pRtnQryQuoteNoticeData,
    struct DFITCErrorRtnField *pErrorInfo, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspForQuote(struct DFITCForQuoteRspField *pRspForQuoteData,
                          struct DFITCErrorRtnField *pErrorInfo) {
  Task task = Task();
...
void TdApi::OnRspQryQuoteOrderInfo(
    struct DFITCQuoteOrderRtnField *pRtnQuoteOrderData,
    struct DFITCErrorRtnField *pErrorInfo, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryForQuote(
    struct DFITCQryForQuoteRtnField *pRtnQryForQuoteData,
    struct DFITCErrorRtnField *pErrorInfo, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryTransferBank(
    struct DFITCTransferBankRspField *pTransferBank,
    struct DFITCErrorRtnField *pErrorInfo, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryTransferSerial(
    struct DFITCTransferSerialRspField *pTransferSerial,
    struct DFITCErrorRtnField *pErrorInfo, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspFromBankToFutureByFuture(
    struct DFITCTransferRspField *pRspTransfer,
    struct DFITCErrorRtnField *pErrorInfo) {
  Task task = Task();
...
void TdApi::OnRtnFromBankToFutureByFuture(
    struct DFITCTransferRtnField *pRtnTransfer,
    struct DFITCErrorRtnField *pErrorInfo) {
  Task task = Task();
...
void TdApi::OnRtnRepealFromFutureToBankByBank(
    struct DFITCRepealRtnField *pRspRepeal) {
  Task task = Task();
...
void TdApi::OnRspQryExchangeStatus(
    struct DFITCExchangeStatusRspField *pRspExchangeStatusData) {
  Task task = Task();
...
void TdApi::OnRtnExchangeStatus(
    struct DFITCExchangeStatusRtnField *pRtnExchangeStatusData) {
  Task task = Task();
...
void TdApi::OnRspQryDepthMarketData(
    struct DFITCDepthMarketDataField *pDepthMarketData,
    struct DFITCErrorRtnField *pErrorInfo, bool bIsLast) {
  Task task = Task();
...
void TdApi::processRspUserLogin(Task task) {
  PyLock lock;
  DFITCUserLoginInfoRtnField task_data =
      any_cast<DFITCUserLoginInfoRtnField>(task.task_data);
  dict data;
...
void TdApi::processRspUserLogout(Task task) {
  PyLock lock;
  DFITCUserLogoutInfoRtnField task_data =
      any_cast<DFITCUserLogoutInfoRtnField>(task.task_data);
  dict data;
...
void TdApi::processRspInsertOrder(Task task) {
  PyLock lock;
  DFITCOrderRspDataRtnField task_data =
      any_cast<DFITCOrderRspDataRtnField>(task.task_data);
  dict data;
...
void TdApi::processRtnCancelOrder(Task task) {
  PyLock lock;
  DFITCOrderCanceledRtnField task_data =
      any_cast<DFITCOrderCanceledRtnField>(task.task_data);
  dict data;
  data["minMatchAmount"] = task_data.minMatchAmount;
  data["insertType"] = task_data.insertType;
  data["customCategory"] = task_data.customCategory;
...
void TdApi::processRspQryOrderInfo(Task task) {
  PyLock lock;
  DFITCOrderCommRtnField task_data =
      any_cast<DFITCOrderCommRtnField>(task.task_data);
  dict data;
...
void TdApi::processRspQryMatchInfo(Task task) {
  PyLock lock;
  DFITCMatchedRtnField task_data =
      any_cast<DFITCMatchedRtnField>(task.task_data);
  dict data;
...
void TdApi::processRspQryPosition(Task task) {
  PyLock lock;
  DFITCPositionInfoRtnField task_data =
      any_cast<DFITCPositionInfoRtnField>(task.task_data);
  dict data;
...
void TdApi::processRspCustomerCapital(Task task) {
  PyLock lock;
  DFITCCapitalInfoRtnField task_data =
      any_cast<DFITCCapitalInfoRtnField>(task.task_data);
  dict data;
...
void TdApi::processRspQryExchangeInstrument(Task task) {
  PyLock lock;
  DFITCExchangeInstrumentRtnField task_data =
      any_cast<DFITCExchangeInstrumentRtnField>(task.task_data);
  dict data;
...
void TdApi::processRspArbitrageInstrument(Task task) {
  PyLock lock;
  DFITCAbiInstrumentRtnField task_data =
      any_cast<DFITCAbiInstrumentRtnField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
...
void TdApi::processRspQrySpecifyInstrument(Task task) {
  PyLock lock;
  DFITCInstrumentRtnField task_data =
      any_cast<DFITCInstrumentRtnField>(task.task_data);
  dict data;
...
void TdApi::processRspQryPositionDetail(Task task) {
  PyLock lock;
  DFITCPositionDetailRtnField task_data =
      any_cast<DFITCPositionDetailRtnField>(task.task_data);
  dict data;
...
void TdApi::processRtnTradingNotice(Task task) {
  PyLock lock;
  DFITCTradingNoticeInfoField task_data =
      any_cast<DFITCTradingNoticeInfoField>(task.task_data);
  dict data;
...
void TdApi::processRspResetPassword(Task task) {
  PyLock lock;
  DFITCResetPwdRspField task_data =
      any_cast<DFITCResetPwdRspField>(task.task_data);
  dict data;
  data["lRequestID"] = task_data.lRequestID;
...
void TdApi::processRspQryTradeCode(Task task) {
  PyLock lock;
  DFITCQryTradeCodeRtnField task_data =
      any_cast<DFITCQryTradeCodeRtnField>(task.task_data);
  dict data;
...
void TdApi::processRspBillConfirm(Task task) {
  PyLock lock;
  DFITCBillConfirmRspField task_data =
      any_cast<DFITCBillConfirmRspField>(task.task_data);
  dict data;
  data["lRequestID"] = task_data.lRequestID;
  data["execState"] = task_data.execState;
  data["accountID"] = task_data.accountID;
...
void TdApi::processRspEquityComputMode(Task task) {
  PyLock lock;
  DFITCEquityComputModeRtnField task_data =
      any_cast<DFITCEquityComputModeRtnField>(task.task_data);
  dict data;
...
void TdApi::processRspQryBill(Task task) {
  PyLock lock;
  DFITCQryBillRtnField task_data =
      any_cast<DFITCQryBillRtnField>(task.task_data);
  dict data;
  data["lRequestID"] = task_data.lRequestID;
...
void TdApi::processRspConfirmProductInfo(Task task) {
  PyLock lock;
  DFITCProductRtnField task_data =
      any_cast<DFITCProductRtnField>(task.task_data);
  dict data;
...
void TdApi::processRspTradingDay(Task task) {
  PyLock lock;
  DFITCTradingDayRtnField task_data =
      any_cast<DFITCTradingDayRtnField>(task.task_data);
  dict data;
...
void TdApi::processRtnQuoteCancel(Task task) {
  PyLock lock;
  DFITCQuoteCanceledRtnField task_data =
      any_cast<DFITCQuoteCanceledRtnField>(task.task_data);
  dict data;
  data["instrumentID"] = task_data.instrumentID;
  data["speculator"] = task_data.speculator;
  data["exchangeID"] = task_data.exchangeID;
...
void TdApi::processRtnQuoteMatchedInfo(Task task) {
  PyLock lock;
  DFITCQuoteMatchRtnField task_data =
      any_cast<DFITCQuoteMatchRtnField>(task.task_data);
  dict data;
  data["quoteID"] = task_data.quoteID;
  data["seatCode"] = task_data.seatCode;
...
void TdApi::processRspCancelAllOrder(Task task) {
  PyLock lock;
  DFITCCancelAllOrderRspField task_data =
      any_cast<DFITCCancelAllOrderRspField>(task.task_data);
  dict data;
  data["lRequestID"] = task_data.lRequestID;
  data["orderStatus"] = task_data.orderStatus;
  data["accountID"] = task_data.accountID;
...
void TdApi::processRspQryQuoteNotice(Task task) {
  PyLock lock;
  DFITCQryQuoteNoticeRtnField task_data =
      any_cast<DFITCQryQuoteNoticeRtnField>(task.task_data);
  dict data;
  data["instrumentID"] = task_data.instrumentID;
  data["exchangeID"] = task_data.exchangeID;
  data["quoteID"] = task_data.quoteID;
...
void TdApi::processRspForQuote(Task task) {
  PyLock lock;
  DFITCForQuoteRspField task_data =
      any_cast<DFITCForQuoteRspField>(task.task_data);
  dict data;
  data["lRequestID"] = task_data.lRequestID;
  data["commTime"] = task_data.commTime;
  data["spdOrderID"] = task_data.spdOrderID;
...
void TdApi::processRtnForQuote(Task task) {
  PyLock lock;
  DFITCForQuoteRtnField task_data =
      any_cast<DFITCForQuoteRtnField>(task.task_data);
  dict data;
  data["instrumentID"] = task_data.instrumentID;
  data["exchangeID"] = task_data.exchangeID;
  data["sessionID"] = task_data.sessionID;
...
void TdApi::processRspQryQuoteOrderInfo(Task task) {
  PyLock lock;
  DFITCQuoteOrderRtnField task_data =
      any_cast<DFITCQuoteOrderRtnField>(task.task_data);
  dict data;
  data["quoteID"] = task_data.quoteID;
  data["sOpenCloseType"] = task_data.sOpenCloseType;
  data["commTime"] = task_data.commTime;
...
void TdApi::processRspQryForQuote(Task task) {
  PyLock lock;
  DFITCQryForQuoteRtnField task_data =
      any_cast<DFITCQryForQuoteRtnField>(task.task_data);
  dict data;
  data["instrumentID"] = task_data.instrumentID;
  data["exchangeID"] = task_data.exchangeID;
  data["SuspendTime"] = task_data.SuspendTime;
...
void TdApi::processRspQryTransferBank(Task task) {
  PyLock lock;
  DFITCTransferBankRspField task_data =
      any_cast<DFITCTransferBankRspField>(task.task_data);
  dict data;
...
void TdApi::processRspQryTransferSerial(Task task) {
  PyLock lock;
  DFITCTransferSerialRspField task_data =
      any_cast<DFITCTransferSerialRspField>(task.task_data);
  dict data;
  data["bankAccount"] = task_data.bankAccount;
...
void TdApi::processRspFromBankToFutureByFuture(Task task) {
  PyLock lock;
  DFITCTransferRspField task_data =
      any_cast<DFITCTransferRspField>(task.task_data);
  dict data;
  data["bankAccount"] = task_data.bankAccount;
...
void TdApi::processRtnFromBankToFutureByFuture(Task task) {
  PyLock lock;
  DFITCTransferRtnField task_data =
      any_cast<DFITCTransferRtnField>(task.task_data);
  dict data;
  data["bankAccount"] = task_data.bankAccount;
  data["bankSerialNum"] = task_data.bankSerialNum;
  data["applyNumber"] = task_data.applyNumber;
...
void TdApi::processRspQryExchangeStatus(Task task) {
  PyLock lock;
  DFITCExchangeStatusRspField task_data =
      any_cast<DFITCExchangeStatusRspField>(task.task_data);
  dict data;
  data["lRequestID"] = task_data.lRequestID;
...
void TdApi::processRtnExchangeStatus(Task task) {
  PyLock lock;
  DFITCExchangeStatusRtnField task_data =
      any_cast<DFITCExchangeStatusRtnField>(task.task_data);
  dict data;
  data["instrumentID"] = task_data.instrumentID;
  data["exchangeID"] = task_data.exchangeID;
  data["exchangeStatus"] = task_data.exchangeStatus;
...
void TdApi::processRspQryDepthMarketData(Task task) {
  PyLock lock;
  DFITCDepthMarketDataField task_data =
      any_cast<DFITCDepthMarketDataField>(task.task_data);
  dict data;
...
int TdApi::reqEquityComputMode() { return this->api->ReqEquityComputMode(); }
...
BOOST_PYTHON_MODULE(vnxspeedtd) {
  ...
  class_<TdApiWrap, boost::noncopyable>("TdApi")
      ...
      .def("onRspCustomerCapital",
           pure_virtual(&TdApiWrap::onRspCustomerCapital))
      .def("onRspQryExchangeInstrument",
           pure_virtual(&TdApiWrap::onRspQryExchangeInstrument))
      .def("onRspArbitrageInstrument",
           pure_virtual(&TdApiWrap::onRspArbitrageInstrument))
      .def("onRspQrySpecifyInstrument",
           pure_virtual(&TdApiWrap::onRspQrySpecifyInstrument))
      .def("onRspQryPositionDetail",
           pure_virtual(&TdApiWrap::onRspQryPositionDetail))
      ...
      .def("onnRspEquityComputMode",
           pure_virtual(&TdApiWrap::onnRspEquityComputMode))
      .def("onRspQryBill", pure_virtual(&TdApiWrap::onRspQryBill))
      .def("onRspConfirmProductInfo",
           pure_virtual(&TdApiWrap::onRspConfirmProductInfo))
      ...
      .def("onRtnQuoteMatchedInfo",
           pure_virtual(&TdApiWrap::onRtnQuoteMatchedInfo))
      ...
      .def("onRspQryQuoteOrderInfo",
           pure_virtual(&TdApiWrap::onRspQryQuoteOrderInfo))
      ...
      .def("onRspQryExchangeStatus",
           pure_virtual(&TdApiWrap::onRspQryExchangeStatus))
      ...
      .def("onRspEquityComputMode",
           pure_virtual(&TdApiWrap::onRspEquityComputMode));
};