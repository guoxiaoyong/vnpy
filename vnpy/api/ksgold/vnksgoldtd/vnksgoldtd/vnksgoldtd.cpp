...
void TdApi::OnRtnDepthMarketData(
...
void TdApi::OnRspQryClientStorage(CThostFtdcStorageField *pStorage,
                                  CThostFtdcRspInfoField *pRspInfo,
...
void TdApi::processNtyMktStatus(Task task) {
  PyLock lock;
  CThostFtdcMarketStatusField task_data =
      any_cast<CThostFtdcMarketStatusField>(task.task_data);
  dict data;
...
void TdApi::processRtnOrder(Task task) {
  PyLock lock;
  CThostFtdcOrderRtnField task_data =
      any_cast<CThostFtdcOrderRtnField>(task.task_data);
  dict data;
...
void TdApi::processRspQryClientStorage(Task task) {
  PyLock lock;
  CThostFtdcStorageField task_data =
      any_cast<CThostFtdcStorageField>(task.task_data);
  dict data;
...
BOOST_PYTHON_MODULE(vnksgoldtd) {
  ...
  class_<TdApiWrap, boost::noncopyable>("TdApi")
      ...
      .def("onRtnDepthMarketData",
           pure_virtual(&TdApiWrap::onRtnDepthMarketData))
      ...
      .def("onRspQryClientStorage",
           pure_virtual(&TdApiWrap::onRspQryClientStorage))
