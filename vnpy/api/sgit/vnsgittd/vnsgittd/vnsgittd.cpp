...
void TdApi::OnRspBatchOrderAction(
  ...
  if (pInputBatchOrderAction) {
    ...
    CThostFtdcInputBatchOrderActionField empty_data =
...
void TdApi::OnErrRtnBatchOrderAction(
  ...
  if (pBatchOrderAction) {
    ...
    CThostFtdcBatchOrderActionField empty_data =
...
void TdApi::processRspBatchOrderAction(Task task) {
  ...
  CThostFtdcInputBatchOrderActionField task_data =
      any_cast<CThostFtdcInputBatchOrderActionField>(task.task_data);
  dict data;
  data["ExchangeID"] = task_data.ExchangeID;
  data["OrderActionRef"] = task_data.OrderActionRef;
  data["UserID"] = task_data.UserID;
...
void TdApi::processErrRtnBatchOrderAction(Task task) {
  PyLock lock;
  CThostFtdcBatchOrderActionField task_data =
      any_cast<CThostFtdcBatchOrderActionField>(task.task_data);
  dict data;
  data["ActionDate"] = task_data.ActionDate;
  data["ExchangeID"] = task_data.ExchangeID;
  data["ActionTime"] = task_data.ActionTime;
...
int TdApi::reqBatchOrderAction(dict req, int nRequestID) {
  CThostFtdcInputBatchOrderActionField myreq =
      CThostFtdcInputBatchOrderActionField();
  memset(&myreq, 0, sizeof(myreq));
  getStr(req, "ExchangeID", myreq.ExchangeID);
  getInt(req, "OrderActionRef", &myreq.OrderActionRef);
...
BOOST_PYTHON_MODULE(vnsgittd) {
  ...
  class_<TdApiWrap, boost::noncopyable>("TdApi")
      ...
      .def("onRspBatchOrderAction",
           pure_virtual(&TdApiWrap::onRspBatchOrderAction))
      ...
      .def("onErrRtnBatchOrderAction",
           pure_virtual(&TdApiWrap::onErrRtnBatchOrderAction))
