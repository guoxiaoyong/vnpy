...
// displayGroupUpdated messages 64 = can receive solicited attrib in openOrder
// message 65 = can receive verifyAndAuthMessageAPI and verifyAndAuthCompleted
// messages 66 = can receive randomize size and randomize price order fields
...
public:
  enum ConnState { CS_DISCONNECTED, CS_CONNECTING, CS_CONNECTED, CS_REDIRECT };
