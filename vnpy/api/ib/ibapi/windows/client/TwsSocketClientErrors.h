...
static const CodeMsgPair CONNECT_FAIL(
    502, "Couldn't connect to TWS. Confirm that \"Enable ActiveX and Socket "
         "Clients\" "
         "is enabled and connection port is the same as \"Socket Port\" on the "
         "TWS \"Edit->Global Configuration...->API->Settings\" menu. Live "
         "Trading ports: "
         "TWS: 7496; IB Gateway: 4001. Simulated Trading ports for new "
         "installations "
         "of version 954.1 or newer:  TWS: 7497; IB Gateway: 4002");
static const CodeMsgPair
    UPDATE_TWS(503, "The TWS is out of date and must be upgraded.");
...
static const CodeMsgPair
    SOCKET_EXCEPTION(509, "Exception caught while reading socket - ");
