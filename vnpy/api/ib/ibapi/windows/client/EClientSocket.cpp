...
bool EClientSocket::asyncEConnect() const { return m_asyncEConnect; }

void EClientSocket::asyncEConnect(bool val) { m_asyncEConnect = val; }
...
bool EClientSocket::isSocketOK() const { return (m_fd >= 0); }

int EClientSocket::fd() const { return m_fd; }
...
void EClientSocket::onError() { handleSocketError(); }