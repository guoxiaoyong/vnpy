...
void DefaultEWrapper::openOrder(OrderId orderId, const Contract &,
...
void DefaultEWrapper::bondContractDetails(
...
void DefaultEWrapper::error(const int id, const int errorCode,
...
void DefaultEWrapper::historicalData(TickerId reqId, const std::string &date,
...
void DefaultEWrapper::commissionReport(
...
void DefaultEWrapper::securityDefinitionOptionalParameter(
...
void DefaultEWrapper::softDollarTiers(
