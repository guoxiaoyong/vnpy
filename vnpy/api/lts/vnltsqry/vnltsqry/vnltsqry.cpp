...
void QryApi::OnRspError(CSecurityFtdcRspInfoField *pRspInfo, int nRequestID,
                        bool bIsLast) {
  Task task = Task();
...
void QryApi::OnRspUserLogin(CSecurityFtdcRspUserLoginField *pRspUserLogin,
...
void QryApi::OnRspUserLogout(CSecurityFtdcUserLogoutField *pUserLogout,
...
void QryApi::OnRspFetchAuthRandCode(
  ...
  if (pAuthRandCode) {
    ...
    CSecurityFtdcAuthRandCodeField empty_data =
...
void QryApi::OnRspQryExchange(CSecurityFtdcExchangeField *pExchange,
                              CSecurityFtdcRspInfoField *pRspInfo,
                              int nRequestID, bool bIsLast) {
  Task task = Task();
...
void QryApi::OnRspQryInstrument(CSecurityFtdcInstrumentField *pInstrument,
                                CSecurityFtdcRspInfoField *pRspInfo,
                                int nRequestID, bool bIsLast) {
  Task task = Task();
...
void QryApi::OnRspQryInvestor(CSecurityFtdcInvestorField *pInvestor,
                              CSecurityFtdcRspInfoField *pRspInfo,
                              int nRequestID, bool bIsLast) {
  Task task = Task();
...
void QryApi::OnRspQryTradingCode(CSecurityFtdcTradingCodeField *pTradingCode,
                                 CSecurityFtdcRspInfoField *pRspInfo,
                                 int nRequestID, bool bIsLast) {
  Task task = Task();
...
void QryApi::OnRspQryTradingAccount(
...
void QryApi::OnRspQryBondInterest(CSecurityFtdcBondInterestField *pBondInterest,
                                  CSecurityFtdcRspInfoField *pRspInfo,
                                  int nRequestID, bool bIsLast) {
  Task task = Task();
...
void QryApi::OnRspQryMarketRationInfo(
...
void QryApi::OnRspQryInstrumentCommissionRate(
...
void QryApi::OnRspQryETFInstrument(
...
void QryApi::OnRspQryETFBasket(CSecurityFtdcETFBasketField *pETFBasket,
                               CSecurityFtdcRspInfoField *pRspInfo,
                               int nRequestID, bool bIsLast) {
  Task task = Task();
...
void QryApi::OnRspQryOFInstrument(CSecurityFtdcOFInstrumentField *pOFInstrument,
                                  CSecurityFtdcRspInfoField *pRspInfo,
                                  int nRequestID, bool bIsLast) {
  Task task = Task();
...
void QryApi::OnRspQrySFInstrument(CSecurityFtdcSFInstrumentField *pSFInstrument,
                                  CSecurityFtdcRspInfoField *pRspInfo,
                                  int nRequestID, bool bIsLast) {
  Task task = Task();
...
void QryApi::OnRspQryInstrumentUnitMargin(
    CSecurityFtdcInstrumentUnitMarginField *pInstrumentUnitMargin,
    CSecurityFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
  ...
  if (pInstrumentUnitMargin) {
    ...
    CSecurityFtdcInstrumentUnitMarginField empty_data =
...
void QryApi::OnRspQryPreDelivInfo(CSecurityFtdcPreDelivInfoField *pPreDelivInfo,
                                  CSecurityFtdcRspInfoField *pRspInfo,
                                  int nRequestID, bool bIsLast) {
  Task task = Task();
  ...
  if (pPreDelivInfo) {
    ...
    CSecurityFtdcPreDelivInfoField empty_data =
...
void QryApi::OnRspQryCreditStockAssignInfo(
    CSecurityFtdcCreditStockAssignInfoField *pCreditStockAssignInfo,
    CSecurityFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
  ...
  if (pCreditStockAssignInfo) {
    ...
    CSecurityFtdcCreditStockAssignInfoField empty_data =
...
void QryApi::OnRspQryCreditCashAssignInfo(
    CSecurityFtdcCreditCashAssignInfoField *pCreditCashAssignInfo,
    CSecurityFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
  ...
  if (pCreditCashAssignInfo) {
    ...
    CSecurityFtdcCreditCashAssignInfoField empty_data =
...
void QryApi::OnRspQryConversionRate(
    CSecurityFtdcConversionRateField *pConversionRate,
    CSecurityFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
  ...
  if (pConversionRate) {
    ...
    CSecurityFtdcConversionRateField empty_data =
...
void QryApi::OnRspQryHisCreditDebtInfo(
    CSecurityFtdcHisCreditDebtInfoField *pHisCreditDebtInfo,
    CSecurityFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
  ...
  if (pHisCreditDebtInfo) {
    ...
    CSecurityFtdcHisCreditDebtInfoField empty_data =
...
void QryApi::OnRspQryMarketDataStaticInfo(
    CSecurityFtdcMarketDataStaticInfoField *pMarketDataStaticInfo,
    CSecurityFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
  ...
  if (pMarketDataStaticInfo) {
    ...
    CSecurityFtdcMarketDataStaticInfoField empty_data =
...
void QryApi::OnRspQryExpireRepurchInfo(
    CSecurityFtdcExpireRepurchInfoField *pExpireRepurchInfo,
    CSecurityFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
  ...
  if (pExpireRepurchInfo) {
    ...
    CSecurityFtdcExpireRepurchInfoField empty_data =
...
void QryApi::OnRspQryBondPledgeRate(
    CSecurityFtdcBondPledgeRateField *pBondPledgeRate,
    CSecurityFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
  ...
  if (pBondPledgeRate) {
    ...
    CSecurityFtdcBondPledgeRateField empty_data =
...
void QryApi::OnRspQryPledgeBond(CSecurityFtdcPledgeBondField *pPledgeBond,
                                CSecurityFtdcRspInfoField *pRspInfo,
                                int nRequestID, bool bIsLast) {
  Task task = Task();
...
void QryApi::OnRspQryOrder(CSecurityFtdcOrderField *pOrder,
                           CSecurityFtdcRspInfoField *pRspInfo, int nRequestID,
                           bool bIsLast) {
  Task task = Task();
...
void QryApi::OnRspQryTrade(CSecurityFtdcTradeField *pTrade,
                           CSecurityFtdcRspInfoField *pRspInfo, int nRequestID,
                           bool bIsLast) {
  Task task = Task();
...
void QryApi::OnRspQryInvestorPosition(
...
void QryApi::OnRspQryFundTransferSerial(
...
void QryApi::OnRspQryFundInterTransferSerial(
...
void QryApi::processRspError(Task task) {
  PyLock lock;
  CSecurityFtdcRspInfoField task_error =
      any_cast<CSecurityFtdcRspInfoField>(task.task_error);
  dict error;
...
void QryApi::processRspUserLogout(Task task) {
  PyLock lock;
  CSecurityFtdcUserLogoutField task_data =
      any_cast<CSecurityFtdcUserLogoutField>(task.task_data);
  dict data;
  data["UserID"] = task_data.UserID;
  data["BrokerID"] = task_data.BrokerID;
...
void QryApi::processRspFetchAuthRandCode(Task task) {
  PyLock lock;
  CSecurityFtdcAuthRandCodeField task_data =
      any_cast<CSecurityFtdcAuthRandCodeField>(task.task_data);
  dict data;
...
void QryApi::processRspQryExchange(Task task) {
  PyLock lock;
  CSecurityFtdcExchangeField task_data =
      any_cast<CSecurityFtdcExchangeField>(task.task_data);
  dict data;
...
void QryApi::processRspQryInstrument(Task task) {
  PyLock lock;
  CSecurityFtdcInstrumentField task_data =
      any_cast<CSecurityFtdcInstrumentField>(task.task_data);
  dict data;
...
void QryApi::processRspQryInvestor(Task task) {
  PyLock lock;
  CSecurityFtdcInvestorField task_data =
      any_cast<CSecurityFtdcInvestorField>(task.task_data);
  dict data;
...
void QryApi::processRspQryTradingCode(Task task) {
  PyLock lock;
  CSecurityFtdcTradingCodeField task_data =
      any_cast<CSecurityFtdcTradingCodeField>(task.task_data);
  dict data;
...
void QryApi::processRspQryTradingAccount(Task task) {
  PyLock lock;
  CSecurityFtdcTradingAccountField task_data =
      any_cast<CSecurityFtdcTradingAccountField>(task.task_data);
  dict data;
...
void QryApi::processRspQryBondInterest(Task task) {
  PyLock lock;
  CSecurityFtdcBondInterestField task_data =
      any_cast<CSecurityFtdcBondInterestField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["TradingDay"] = task_data.TradingDay;
  data["ExchangeID"] = task_data.ExchangeID;
...
void QryApi::processRspQryMarketRationInfo(Task task) {
  PyLock lock;
  CSecurityFtdcMarketRationInfoField task_data =
      any_cast<CSecurityFtdcMarketRationInfoField>(task.task_data);
  dict data;
  data["InvestorID"] = task_data.InvestorID;
  data["ExchangeID"] = task_data.ExchangeID;
  data["BrokerID"] = task_data.BrokerID;
...
void QryApi::processRspQryInstrumentCommissionRate(Task task) {
  PyLock lock;
  CSecurityFtdcInstrumentCommissionRateField task_data =
      any_cast<CSecurityFtdcInstrumentCommissionRateField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
...
void QryApi::processRspQryETFInstrument(Task task) {
  PyLock lock;
  CSecurityFtdcETFInstrumentField task_data =
      any_cast<CSecurityFtdcETFInstrumentField>(task.task_data);
  dict data;
...
void QryApi::processRspQryETFBasket(Task task) {
  PyLock lock;
  CSecurityFtdcETFBasketField task_data =
      any_cast<CSecurityFtdcETFBasketField>(task.task_data);
  dict data;
  data["ETFInstrumentID"] = task_data.ETFInstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
...
void QryApi::processRspQryOFInstrument(Task task) {
  PyLock lock;
  CSecurityFtdcOFInstrumentField task_data =
      any_cast<CSecurityFtdcOFInstrumentField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
...
void QryApi::processRspQrySFInstrument(Task task) {
  PyLock lock;
  CSecurityFtdcSFInstrumentField task_data =
      any_cast<CSecurityFtdcSFInstrumentField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
  data["NetPrice"] = task_data.NetPrice;
...
void QryApi::processRspQryInstrumentUnitMargin(Task task) {
  PyLock lock;
  CSecurityFtdcInstrumentUnitMarginField task_data =
      any_cast<CSecurityFtdcInstrumentUnitMarginField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["InvestorID"] = task_data.InvestorID;
  data["ExchangeID"] = task_data.ExchangeID;
...
void QryApi::processRspQryPreDelivInfo(Task task) {
  PyLock lock;
  CSecurityFtdcPreDelivInfoField task_data =
      any_cast<CSecurityFtdcPreDelivInfoField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
...
void QryApi::processRspQryCreditStockAssignInfo(Task task) {
  PyLock lock;
  CSecurityFtdcCreditStockAssignInfoField task_data =
      any_cast<CSecurityFtdcCreditStockAssignInfoField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
  ...
  this->onRspQryCreditStockAssignInfo(data, error, task.task_id,
                                      task.task_last);
};

void QryApi::processRspQryCreditCashAssignInfo(Task task) {
  PyLock lock;
  CSecurityFtdcCreditCashAssignInfoField task_data =
      any_cast<CSecurityFtdcCreditCashAssignInfoField>(task.task_data);
  dict data;
  data["InvestorID"] = task_data.InvestorID;
...
void QryApi::processRspQryConversionRate(Task task) {
  PyLock lock;
  CSecurityFtdcConversionRateField task_data =
      any_cast<CSecurityFtdcConversionRateField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
...
void QryApi::processRspQryHisCreditDebtInfo(Task task) {
  PyLock lock;
  CSecurityFtdcHisCreditDebtInfoField task_data =
      any_cast<CSecurityFtdcHisCreditDebtInfoField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
  data["Direction"] = task_data.Direction;
...
void QryApi::processRspQryMarketDataStaticInfo(Task task) {
  PyLock lock;
  CSecurityFtdcMarketDataStaticInfoField task_data =
      any_cast<CSecurityFtdcMarketDataStaticInfoField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
...
void QryApi::processRspQryExpireRepurchInfo(Task task) {
  PyLock lock;
  CSecurityFtdcExpireRepurchInfoField task_data =
      any_cast<CSecurityFtdcExpireRepurchInfoField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
...
void QryApi::processRspQryBondPledgeRate(Task task) {
  PyLock lock;
  CSecurityFtdcBondPledgeRateField task_data =
      any_cast<CSecurityFtdcBondPledgeRateField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
...
void QryApi::processRspQryPledgeBond(Task task) {
  PyLock lock;
  CSecurityFtdcPledgeBondField task_data =
      any_cast<CSecurityFtdcPledgeBondField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
...
void QryApi::processRspQryOrder(Task task) {
  PyLock lock;
  CSecurityFtdcOrderField task_data =
      any_cast<CSecurityFtdcOrderField>(task.task_data);
  dict data;
...
void QryApi::processRspQryTrade(Task task) {
  PyLock lock;
  CSecurityFtdcTradeField task_data =
      any_cast<CSecurityFtdcTradeField>(task.task_data);
  dict data;
...
void QryApi::processRspQryInvestorPosition(Task task) {
  PyLock lock;
  CSecurityFtdcInvestorPositionField task_data =
      any_cast<CSecurityFtdcInvestorPositionField>(task.task_data);
  dict data;
...
void QryApi::processRspQryFundTransferSerial(Task task) {
  PyLock lock;
  CSecurityFtdcFundTransferField task_data =
      any_cast<CSecurityFtdcFundTransferField>(task.task_data);
  dict data;
...
void QryApi::processRspQryFundInterTransferSerial(Task task) {
  PyLock lock;
  CSecurityFtdcFundInterTransferSerialField task_data =
      any_cast<CSecurityFtdcFundInterTransferSerialField>(task.task_data);
  dict data;
  ...
  this->onRspQryFundInterTransferSerial(data, error, task.task_id,
                                        task.task_last);
};
...
void QryApi::release() { this->api->Release(); };

void QryApi::init() { this->api->Init(); };
...
int QryApi::reqQryTradingAccount(dict req, int nRequestID) {
  CSecurityFtdcQryTradingAccountField myreq =
...
int QryApi::reqQryMarketRationInfo(dict req, int nRequestID) {
  CSecurityFtdcQryMarketRationInfoField myreq =
...
int QryApi::reqQryInstrumentCommissionRate(dict req, int nRequestID) {
  CSecurityFtdcQryInstrumentCommissionRateField myreq =
...
int QryApi::reqQryETFInstrument(dict req, int nRequestID) {
  CSecurityFtdcQryETFInstrumentField myreq =
...
int QryApi::reqQryInstrumentUnitMargin(dict req, int nRequestID) {
  CSecurityFtdcQryInstrumentUnitMarginField myreq =
...
int QryApi::reqQryCreditStockAssignInfo(dict req, int nRequestID) {
  CSecurityFtdcQryCreditStockAssignInfoField myreq =
...
int QryApi::reqQryCreditCashAssignInfo(dict req, int nRequestID) {
  CSecurityFtdcQryCreditCashAssignInfoField myreq =
...
int QryApi::reqQryConversionRate(dict req, int nRequestID) {
  CSecurityFtdcQryConversionRateField myreq =
...
int QryApi::reqQryHisCreditDebtInfo(dict req, int nRequestID) {
  CSecurityFtdcQryHisCreditDebtInfoField myreq =
...
int QryApi::reqQryMarketDataStaticInfo(dict req, int nRequestID) {
  CSecurityFtdcQryMarketDataStaticInfoField myreq =
...
int QryApi::reqQryExpireRepurchInfo(dict req, int nRequestID) {
  CSecurityFtdcQryExpireRepurchInfoField myreq =
...
int QryApi::reqQryBondPledgeRate(dict req, int nRequestID) {
  CSecurityFtdcQryBondPledgeRateField myreq =
...
int QryApi::reqQryInvestorPosition(dict req, int nRequestID) {
  CSecurityFtdcQryInvestorPositionField myreq =
...
int QryApi::reqQryFundTransferSerial(dict req, int nRequestID) {
  CSecurityFtdcQryFundTransferSerialField myreq =
...
int QryApi::reqQryFundInterTransferSerial(dict req, int nRequestID) {
  CSecurityFtdcQryFundInterTransferSerialField myreq =
...
struct QryApiWrap : QryApi, wrapper<QryApi> {
  ...
  virtual void onRspFetchAuthRandCode(dict data, dict error, int id,
                                      bool last) {
    try {
  ...
  virtual void onRspQryMarketRationInfo(dict data, dict error, int id,
                                        bool last) {
    try {
  ...
  virtual void onRspQryInstrumentUnitMargin(dict data, dict error, int id,
                                            bool last) {
    try {
  ...
  virtual void onRspQryCreditStockAssignInfo(dict data, dict error, int id,
                                             bool last) {
    try {
      this->get_override("onRspQryCreditStockAssignInfo")(data, error, id,
                                                          last);
    } catch (error_already_set const &) {
      PyErr_Print();
    }
  ...
  virtual void onRspQryCreditCashAssignInfo(dict data, dict error, int id,
                                            bool last) {
    try {
  ...
  virtual void onRspQryConversionRate(dict data, dict error, int id,
                                      bool last) {
    try {
  ...
  virtual void onRspQryHisCreditDebtInfo(dict data, dict error, int id,
                                         bool last) {
    try {
  ...
  virtual void onRspQryMarketDataStaticInfo(dict data, dict error, int id,
                                            bool last) {
    try {
  ...
  virtual void onRspQryExpireRepurchInfo(dict data, dict error, int id,
                                         bool last) {
    try {
  ...
  virtual void onRspQryBondPledgeRate(dict data, dict error, int id,
                                      bool last) {
    try {
  ...
  virtual void onRspQryFundTransferSerial(dict data, dict error, int id,
                                          bool last) {
    try {
  ...
  virtual void onRspQryFundInterTransferSerial(dict data, dict error, int id,
                                               bool last) {
    try {
      this->get_override("onRspQryFundInterTransferSerial")(data, error, id,
                                                            last);
    } catch (error_already_set const &) {
      PyErr_Print();
    }
...
BOOST_PYTHON_MODULE(vnltsqry) {
  ...
  class_<QryApiWrap, boost::noncopyable>("QryApi")
      ...
      .def("reqQryInstrumentCommissionRate",
           &QryApiWrap::reqQryInstrumentCommissionRate)
      ...
      .def("reqQryFundInterTransferSerial",
           &QryApiWrap::reqQryFundInterTransferSerial)

      .def("onFrontConnected", pure_virtual(&QryApiWrap::onFrontConnected))
      .def("onFrontDisconnected",
           pure_virtual(&QryApiWrap::onFrontDisconnected))
      ...
      .def("onRspFetchAuthRandCode",
           pure_virtual(&QryApiWrap::onRspFetchAuthRandCode))
      ...
      .def("onRspQryTradingCode",
           pure_virtual(&QryApiWrap::onRspQryTradingCode))
      .def("onRspQryTradingAccount",
           pure_virtual(&QryApiWrap::onRspQryTradingAccount))
      .def("onRspQryBondInterest",
           pure_virtual(&QryApiWrap::onRspQryBondInterest))
      .def("onRspQryMarketRationInfo",
           pure_virtual(&QryApiWrap::onRspQryMarketRationInfo))
      .def("onRspQryInstrumentCommissionRate",
           pure_virtual(&QryApiWrap::onRspQryInstrumentCommissionRate))
      .def("onRspQryETFInstrument",
           pure_virtual(&QryApiWrap::onRspQryETFInstrument))
      .def("onRspQryETFBasket", pure_virtual(&QryApiWrap::onRspQryETFBasket))
      .def("onRspQryOFInstrument",
           pure_virtual(&QryApiWrap::onRspQryOFInstrument))
      .def("onRspQrySFInstrument",
           pure_virtual(&QryApiWrap::onRspQrySFInstrument))
      .def("onRspQryOrder", pure_virtual(&QryApiWrap::onRspQryOrder))
      .def("onRspQryTrade", pure_virtual(&QryApiWrap::onRspQryTrade))
      .def("onRspQryInvestorPosition",
           pure_virtual(&QryApiWrap::onRspQryInvestorPosition))
      .def("onRspQryFundTransferSerial",
           pure_virtual(&QryApiWrap::onRspQryFundTransferSerial))
      .def("onRspQryFundInterTransferSerial",
           pure_virtual(&QryApiWrap::onRspQryFundInterTransferSerial));
}
