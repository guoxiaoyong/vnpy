...
void TdApi::OnRspError(CQdpFtdcRspInfoField *pRspInfo, int nRequestID,
                       bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspUserLogin(CQdpFtdcRspUserLoginField *pRspUserLogin,
...
void TdApi::OnRspUserLogout(CQdpFtdcRspUserLogoutField *pRspUserLogout,
                            CQdpFtdcRspInfoField *pRspInfo, int nRequestID,
                            bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspUserPasswordUpdate(
  ...
  if (pUserPasswordUpdate) {
    ...
    CQdpFtdcUserPasswordUpdateField empty_data =
...
void TdApi::OnRspOrderInsert(CQdpFtdcInputOrderField *pInputOrder,
                             CQdpFtdcRspInfoField *pRspInfo, int nRequestID,
                             bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspOrderAction(CQdpFtdcOrderActionField *pOrderAction,
                             CQdpFtdcRspInfoField *pRspInfo, int nRequestID,
                             bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspFromBankToFutureByFuture(
    CQdpFtdcReqTransferField *pReqTransfer, CQdpFtdcRspInfoField *pRspInfo,
...
void TdApi::OnRtnFlowMessageCancel(
    CQdpFtdcFlowMessageCancelField *pFlowMessageCancel) {
  Task task = Task();
  ...
  if (pFlowMessageCancel) {
    ...
    CQdpFtdcFlowMessageCancelField empty_data =
...
void TdApi::OnErrRtnOrderInsert(CQdpFtdcInputOrderField *pInputOrder,
...
void TdApi::OnErrRtnOrderAction(CQdpFtdcOrderActionField *pOrderAction,
                                CQdpFtdcRspInfoField *pRspInfo) {
  Task task = Task();
...
void TdApi::OnRtnInstrumentStatus(
    CQdpFtdcInstrumentStatusField *pInstrumentStatus) {
  Task task = Task();
...
void TdApi::OnRtnInvestorAccountDeposit(
  ...
  if (pInvestorAccountDepositRes) {
    ...
    CQdpFtdcInvestorAccountDepositResField empty_data =
...
void TdApi::OnRtnMessageNotify(
  ...
  if (pMessageNotifyInfo) {
    ...
    CQdpFtdcMessageNotifyInfoField empty_data =
...
void TdApi::OnErrRtnBankToFutureByFuture(CQdpFtdcReqTransferField *pReqTransfer,
                                         CQdpFtdcRspInfoField *pRspInfo) {
  Task task = Task();
...
void TdApi::OnErrRtnFutureToBankByFuture(CQdpFtdcReqTransferField *pReqTransfer,
                                         CQdpFtdcRspInfoField *pRspInfo) {
  Task task = Task();
...
void TdApi::OnRtnQueryBankBalanceByFuture(
  ...
  if (pNotifyQueryAccount) {
    ...
    CQdpFtdcNotifyQueryAccountField empty_data =
...
void TdApi::OnRtnFromBankToFutureByFuture(
    CQdpFtdcRspTransferField *pRspTransfer) {
  Task task = Task();
...
void TdApi::OnRspQryOrder(CQdpFtdcOrderField *pOrder,
                          CQdpFtdcRspInfoField *pRspInfo, int nRequestID,
                          bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryTrade(CQdpFtdcTradeField *pTrade,
                          CQdpFtdcRspInfoField *pRspInfo, int nRequestID,
                          bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryUserInvestor(CQdpFtdcRspUserInvestorField *pRspUserInvestor,
                                 CQdpFtdcRspInfoField *pRspInfo, int nRequestID,
                                 bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryInvestorAccount(
    CQdpFtdcRspInvestorAccountField *pRspInvestorAccount,
    CQdpFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  Task task = Task();
  ...
  if (pRspInvestorAccount) {
    ...
    CQdpFtdcRspInvestorAccountField empty_data =
...
void TdApi::OnRspQryInstrument(CQdpFtdcRspInstrumentField *pRspInstrument,
                               CQdpFtdcRspInfoField *pRspInfo, int nRequestID,
                               bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryExchange(CQdpFtdcRspExchangeField *pRspExchange,
                             CQdpFtdcRspInfoField *pRspInfo, int nRequestID,
                             bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryInvestorPosition(
  ...
  if (pRspInvestorPosition) {
    ...
    CQdpFtdcRspInvestorPositionField empty_data =
...
void TdApi::OnRspSubscribeTopic(CQdpFtdcDisseminationField *pDissemination,
                                CQdpFtdcRspInfoField *pRspInfo, int nRequestID,
                                bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryTopic(CQdpFtdcDisseminationField *pDissemination,
                          CQdpFtdcRspInfoField *pRspInfo, int nRequestID,
                          bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryInvestorFee(CQdpFtdcInvestorFeeField *pInvestorFee,
                                CQdpFtdcRspInfoField *pRspInfo, int nRequestID,
                                bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryInvestorMargin(CQdpFtdcInvestorMarginField *pInvestorMargin,
                                   CQdpFtdcRspInfoField *pRspInfo,
                                   int nRequestID, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryExchangeDiffTime(
  ...
  if (pRspExchangeDiffTime) {
    ...
    CQdpFtdcRspExchangeDiffTimeField empty_data =
...
void TdApi::OnRspQryContractBank(CQdpFtdcContractBankField *pContractBank,
                                 CQdpFtdcRspInfoField *pRspInfo, int nRequestID,
                                 bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryTransferSerial(CQdpFtdcTransferSerialField *pTransferSerial,
                                   CQdpFtdcRspInfoField *pRspInfo,
                                   int nRequestID, bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQrySGEDeferRate(CQdpFtdcSGEDeferRateField *pSGEDeferRate,
                                 CQdpFtdcRspInfoField *pRspInfo, int nRequestID,
                                 bool bIsLast) {
  Task task = Task();
...
void TdApi::OnRspQryMarketData(CQdpFtdcMarketDataField *pMarketData,
                               CQdpFtdcRspInfoField *pRspInfo, int nRequestID,
                               bool bIsLast) {
  Task task = Task();
...
void TdApi::processRspError(Task task) {
  PyLock lock;
  CQdpFtdcRspInfoField task_error =
      any_cast<CQdpFtdcRspInfoField>(task.task_error);
  dict error;
...
void TdApi::processRspUserLogin(Task task) {
  PyLock lock;
  CQdpFtdcRspUserLoginField task_data =
      any_cast<CQdpFtdcRspUserLoginField>(task.task_data);
  dict data;
...
void TdApi::processRspUserLogout(Task task) {
  PyLock lock;
  CQdpFtdcRspUserLogoutField task_data =
      any_cast<CQdpFtdcRspUserLogoutField>(task.task_data);
  dict data;
  data["UserID"] = task_data.UserID;
  data["BrokerID"] = task_data.BrokerID;
...
void TdApi::processRspUserPasswordUpdate(Task task) {
  PyLock lock;
  CQdpFtdcUserPasswordUpdateField task_data =
      any_cast<CQdpFtdcUserPasswordUpdateField>(task.task_data);
  dict data;
  data["UserID"] = task_data.UserID;
...
void TdApi::processRspOrderInsert(Task task) {
  PyLock lock;
  CQdpFtdcInputOrderField task_data =
      any_cast<CQdpFtdcInputOrderField>(task.task_data);
  dict data;
...
void TdApi::processRspOrderAction(Task task) {
  PyLock lock;
  CQdpFtdcOrderActionField task_data =
      any_cast<CQdpFtdcOrderActionField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
...
void TdApi::processRspFromBankToFutureByFuture(Task task) {
  PyLock lock;
  CQdpFtdcReqTransferField task_data =
      any_cast<CQdpFtdcReqTransferField>(task.task_data);
  dict data;
...
void TdApi::processRtnFlowMessageCancel(Task task) {
  PyLock lock;
  CQdpFtdcFlowMessageCancelField task_data =
      any_cast<CQdpFtdcFlowMessageCancelField>(task.task_data);
  dict data;
  data["DataCenterID"] = task_data.DataCenterID;
  data["TradingDay"] = task_data.TradingDay;
...
void TdApi::processRtnInstrumentStatus(Task task) {
  PyLock lock;
  CQdpFtdcInstrumentStatusField task_data =
      any_cast<CQdpFtdcInstrumentStatusField>(task.task_data);
  dict data;
...
void TdApi::processRtnInvestorAccountDeposit(Task task) {
  PyLock lock;
  CQdpFtdcInvestorAccountDepositResField task_data =
      any_cast<CQdpFtdcInvestorAccountDepositResField>(task.task_data);
  dict data;
...
void TdApi::processRtnMessageNotify(Task task) {
  PyLock lock;
  CQdpFtdcMessageNotifyInfoField task_data =
      any_cast<CQdpFtdcMessageNotifyInfoField>(task.task_data);
  dict data;
...
void TdApi::processErrRtnQueryBankBalanceByFuture(Task task) {
  PyLock lock;
  CQdpFtdcReqQueryAccountField task_data =
      any_cast<CQdpFtdcReqQueryAccountField>(task.task_data);
  dict data;
  data["VerifyCertNoFlag"] = task_data.VerifyCertNoFlag;
  data["BrokerBranchID"] = task_data.BrokerBranchID;
  data["UserID"] = task_data.UserID;
...
void TdApi::processRtnQueryBankBalanceByFuture(Task task) {
  PyLock lock;
  CQdpFtdcNotifyQueryAccountField task_data =
      any_cast<CQdpFtdcNotifyQueryAccountField>(task.task_data);
  dict data;
  data["VerifyCertNoFlag"] = task_data.VerifyCertNoFlag;
  data["BrokerBranchID"] = task_data.BrokerBranchID;
  data["UserID"] = task_data.UserID;
...
void TdApi::processRtnFromBankToFutureByFuture(Task task) {
  PyLock lock;
  CQdpFtdcRspTransferField task_data =
      any_cast<CQdpFtdcRspTransferField>(task.task_data);
  dict data;
  data["VerifyCertNoFlag"] = task_data.VerifyCertNoFlag;
  data["BrokerBranchID"] = task_data.BrokerBranchID;
  data["UserID"] = task_data.UserID;
...
void TdApi::processRtnSGEDeferRate(Task task) {
  PyLock lock;
  CQdpFtdcSGEDeferRateField task_data =
      any_cast<CQdpFtdcSGEDeferRateField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
...
void TdApi::processRspQryUserInvestor(Task task) {
  PyLock lock;
  CQdpFtdcRspUserInvestorField task_data =
      any_cast<CQdpFtdcRspUserInvestorField>(task.task_data);
  dict data;
  data["UserID"] = task_data.UserID;
  data["BrokerID"] = task_data.BrokerID;
  data["InvestorID"] = task_data.InvestorID;
...
void TdApi::processRspQryInvestorAccount(Task task) {
  PyLock lock;
  CQdpFtdcRspInvestorAccountField task_data =
      any_cast<CQdpFtdcRspInvestorAccountField>(task.task_data);
  dict data;
...
void TdApi::processRspQryInstrument(Task task) {
  PyLock lock;
  CQdpFtdcRspInstrumentField task_data =
      any_cast<CQdpFtdcRspInstrumentField>(task.task_data);
  dict data;
  data["IsTrading"] = task_data.IsTrading;
  data["ExpireDate"] = task_data.ExpireDate;
  data["StrikePrice"] = task_data.StrikePrice;
...
void TdApi::processRspQryExchange(Task task) {
  PyLock lock;
  CQdpFtdcRspExchangeField task_data =
      any_cast<CQdpFtdcRspExchangeField>(task.task_data);
  dict data;
  data["TradingDay"] = task_data.TradingDay;
  data["ExchangeID"] = task_data.ExchangeID;
...
void TdApi::processRspQryInvestorPosition(Task task) {
  PyLock lock;
  CQdpFtdcRspInvestorPositionField task_data =
      any_cast<CQdpFtdcRspInvestorPositionField>(task.task_data);
  dict data;
  data["FrozenMargin"] = task_data.FrozenMargin;
  data["HedgeFlag"] = task_data.HedgeFlag;
  data["PositionProfit"] = task_data.PositionProfit;
...
void TdApi::processRspSubscribeTopic(Task task) {
  PyLock lock;
  CQdpFtdcDisseminationField task_data =
      any_cast<CQdpFtdcDisseminationField>(task.task_data);
  dict data;
...
void TdApi::processRspQryInvestorFee(Task task) {
  PyLock lock;
  CQdpFtdcInvestorFeeField task_data =
      any_cast<CQdpFtdcInvestorFeeField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
...
void TdApi::processRspQryInvestorMargin(Task task) {
  PyLock lock;
  CQdpFtdcInvestorMarginField task_data =
      any_cast<CQdpFtdcInvestorMarginField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
...
void TdApi::processRspQryExchangeDiffTime(Task task) {
  PyLock lock;
  CQdpFtdcRspExchangeDiffTimeField task_data =
      any_cast<CQdpFtdcRspExchangeDiffTimeField>(task.task_data);
  dict data;
...
void TdApi::processRspQryContractBank(Task task) {
  PyLock lock;
  CQdpFtdcContractBankField task_data =
      any_cast<CQdpFtdcContractBankField>(task.task_data);
  dict data;
  data["Currency"] = task_data.Currency;
...
void TdApi::processRspQryTransferSerial(Task task) {
  PyLock lock;
  CQdpFtdcTransferSerialField task_data =
      any_cast<CQdpFtdcTransferSerialField>(task.task_data);
  dict data;
...
void TdApi::processRspQryMarketData(Task task) {
  PyLock lock;
  CQdpFtdcMarketDataField task_data =
      any_cast<CQdpFtdcMarketDataField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
  data["ExchangeID"] = task_data.ExchangeID;
...
struct TdApiWrap : TdApi, wrapper<TdApi> {
  ...
  virtual void onRspQryInvestorAccount(dict data, dict error, int id,
                                       bool last) {
    try {
  ...
  virtual void onRspQryInvestorMargin(dict data, dict error, int id,
                                      bool last) {
    try {
  ...
  virtual void onRspQryExchangeDiffTime(dict data, dict error, int id,
                                        bool last) {
    try {
...
BOOST_PYTHON_MODULE(vnqdptd) {
  ...
  class_<TdApiWrap, boost::noncopyable>("TdApi")
      ...
      .def("onRtnFlowMessageCancel",
           pure_virtual(&TdApiWrap::onRtnFlowMessageCancel))
      ...
      .def("onRtnInvestorAccountDeposit",
           pure_virtual(&TdApiWrap::onRtnInvestorAccountDeposit))
      ...
      .def("onRspQryUserInvestor",
           pure_virtual(&TdApiWrap::onRspQryUserInvestor))
      .def("onRspQryInvestorAccount",
           pure_virtual(&TdApiWrap::onRspQryInvestorAccount))
      ...
      .def("onRspQryInvestorMargin",
           pure_virtual(&TdApiWrap::onRspQryInvestorMargin))
      .def("onRspQryExchangeDiffTime",
           pure_virtual(&TdApiWrap::onRspQryExchangeDiffTime))
      ...
      .def("onRspQrySGEDeferRate",
           pure_virtual(&TdApiWrap::onRspQrySGEDeferRate))
