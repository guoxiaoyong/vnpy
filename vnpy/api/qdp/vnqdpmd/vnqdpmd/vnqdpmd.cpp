...
void MdApi::OnRspError(CQdpFtdcRspInfoField *pRspInfo, int nRequestID,
                       bool bIsLast) {
  Task task = Task();
...
void MdApi::OnRspUserLogin(CQdpFtdcRspUserLoginField *pRspUserLogin,
...
void MdApi::OnRspUserLogout(CQdpFtdcRspUserLogoutField *pRspUserLogout,
                            CQdpFtdcRspInfoField *pRspInfo, int nRequestID,
                            bool bIsLast) {
  Task task = Task();
...
void MdApi::OnRtnQmdInstrumentStatu(
    CQdpFtdcQmdInstrumentStateField *pQmdInstrumentState) {
  Task task = Task();
  ...
  if (pQmdInstrumentState) {
    ...
    CQdpFtdcQmdInstrumentStateField empty_data =
...
void MdApi::OnRspSubscribeTopic(CQdpFtdcDisseminationField *pDissemination,
                                CQdpFtdcRspInfoField *pRspInfo, int nRequestID,
                                bool bIsLast) {
  Task task = Task();
...
void MdApi::OnRspQryTopic(CQdpFtdcDisseminationField *pDissemination,
                          CQdpFtdcRspInfoField *pRspInfo, int nRequestID,
                          bool bIsLast) {
  Task task = Task();
...
void MdApi::OnRtnDepthMarketData(
    CQdpFtdcDepthMarketDataField *pDepthMarketData) {
  Task task = Task();
...
void MdApi::OnRspSubMarketData(
    CQdpFtdcSpecificInstrumentField *pSpecificInstrument,
  ...
  if (pSpecificInstrument) {
    ...
    CQdpFtdcSpecificInstrumentField empty_data =
...
void MdApi::OnRspQryDepthMarketData(CQdpFtdcRspMarketDataField *pRspMarketData,
...
void MdApi::processUdpMarketData(Task task) {
  //手动修改
  PyLock lock;
  CQdpFtdcDepthMarketDataField task_data =
      any_cast<CQdpFtdcDepthMarketDataField>(task.task_data);
  dict data;
...
void MdApi::processRtnQmdInstrumentStatu(Task task) {
  PyLock lock;
  CQdpFtdcQmdInstrumentStateField task_data =
      any_cast<CQdpFtdcQmdInstrumentStateField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
...
void MdApi::processRspSubMarketData(Task task) {
  PyLock lock;
  CQdpFtdcSpecificInstrumentField task_data =
      any_cast<CQdpFtdcSpecificInstrumentField>(task.task_data);
  dict data;
  data["InstrumentID"] = task_data.InstrumentID;
...
void MdApi::processRspQryDepthMarketData(Task task) {
  PyLock lock;
  CQdpFtdcRspMarketDataField task_data =
      any_cast<CQdpFtdcRspMarketDataField>(task.task_data);
  dict data;
  data["HighestPrice"] = task_data.HighestPrice;
  data["BidPrice1"] = task_data.BidPrice1;
  data["LowerLimitPrice"] = task_data.LowerLimitPrice;
...
BOOST_PYTHON_MODULE(vnqdpmd) {
  ...
  class_<MdApiWrap, boost::noncopyable>("MdApi")
      ...
      .def("onRtnQmdInstrumentStatu",
           pure_virtual(&MdApiWrap::onRtnQmdInstrumentStatu))
      ...
      .def("onRspQryDepthMarketData",
           pure_virtual(&MdApiWrap::onRspQryDepthMarketData));
};
